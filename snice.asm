...
int main(int argc, char* argv[]){
  ...
  34:	e8 67 00 00 00       	call   a0 <myatoi>
	val = myatoi(argv[2]);
  39:	59                   	pop    %ecx
  ...
  3d:	89 c6                	mov    %eax,%esi
	val = myatoi(argv[2]);
  3f:	e8 5c 00 00 00       	call   a0 <myatoi>
  ...
  48:	53                   	push   %ebx
  49:	56                   	push   %esi
  4a:	e8 83 03 00 00       	call   3d2 <setnice>
  4f:	83 c4 10             	add    $0x10,%esp
  52:	85 c0                	test   %eax,%eax
  54:	74 0f                	je     65 <main+0x65>
		printf(1, "Nice of PID <%d> is set to %d\n", pid, val);
	else if (rv == -1) {
  56:	83 f8 ff             	cmp    $0xffffffff,%eax
  59:	74 1d                	je     78 <main+0x78>
		printf(2, "Error: PID <%d> NOT found! \n", pid);
	}
	else if (rv == -2) {
  5b:	83 f8 fe             	cmp    $0xfffffffe,%eax
  5e:	74 2b                	je     8b <main+0x8b>
  ...
  76:	eb e8                	jmp    60 <main+0x60>
		printf(2, "Error: PID <%d> NOT found! \n", pid);
  78:	52                   	push   %edx
  79:	56                   	push   %esi
  7a:	68 00 08 00 00       	push   $0x800
  7f:	6a 02                	push   $0x2
...
000000a0 <myatoi>:
{
  ...
  a6:	8b 45 08             	mov    0x8(%ebp),%eax
	if (str[0]=='-') {
  a9:	80 38 2d             	cmpb   $0x2d,(%eax)
  ac:	74 0a                	je     b8 <myatoi+0x18>
}
  ae:	c9                   	leave  
	else return atoi(str);
  af:	e9 fc 01 00 00       	jmp    2b0 <atoi>
  b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		return -1*atoi(&str[1]);
  b8:	83 ec 0c             	sub    $0xc,%esp
  bb:	83 c0 01             	add    $0x1,%eax
  be:	50                   	push   %eax
  bf:	e8 ec 01 00 00       	call   2b0 <atoi>
 ...
 661:	a1 40 0b 00 00       	mov    0xb40,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 40 0b 00 00       	mov    %eax,0xb40
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 40 0b 00 00       	mov    %eax,0xb40
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 40 0b 00 00    	cmp    %eax,0xb40
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 40 0b 00 00    	mov    0xb40,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 40 0b 00 00    	mov    %edx,0xb40
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 40 0b 00 00 44 	movl   $0xb44,0xb40
 7b7:	0b 00 00 
 7ba:	c7 05 44 0b 00 00 44 	movl   $0xb44,0xb44
 7c1:	0b 00 00 
    base.s.size = 0;
 7c4:	b8 44 0b 00 00       	mov    $0xb44,%eax
 7c9:	c7 05 48 0b 00 00 00 	movl   $0x0,0xb48
 7d0:	00 00 00 
