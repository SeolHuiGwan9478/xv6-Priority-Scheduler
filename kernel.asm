...
801002c5:	e8 b6 3c 00 00       	call   80103f80 <sleep>
    while(input.r == input.w){
...
801002e0:	8b 40 2c             	mov    0x2c(%eax),%eax
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 93 7c 10 80 	movl   $0x80107c93,(%esp)
...
80100d06:	83 c0 74             	add    $0x74,%eax
...
80100d17:	8b 7f 0c             	mov    0xc(%edi),%edi
  curproc->tf->eip = elf.entry;  // main
80100d1a:	8b 41 20             	mov    0x20(%ecx),%eax
  curproc->sz = sz;
80100d1d:	89 71 08             	mov    %esi,0x8(%ecx)
  curproc->pgdir = pgdir;
80100d20:	89 51 0c             	mov    %edx,0xc(%ecx)
  curproc->tf->eip = elf.entry;  // main
80100d23:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d29:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d2c:	8b 41 20             	mov    0x20(%ecx),%eax
80100d2f:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d32:	89 0c 24             	mov    %ecx,(%esp)
80100d35:	e8 c6 5e 00 00       	call   80106c00 <switchuvm>
  freevm(oldpgdir);
80100d3a:	89 3c 24             	mov    %edi,(%esp)
80100d3d:	e8 6e 62 00 00       	call   80106fb0 <freevm>
  return 0;
...
80101c8e:	83 ec 0c             	sub    $0xc,%esp
    ip = idup(myproc()->cwd);
80101c91:	8b 70 70             	mov    0x70(%eax),%esi
  acquire(&icache.lock);
...
80101ed8:	68 72 7a 10 80       	push   $0x80107a72
...
80102020:	e8 1b 25 00 00       	call   80104540 <initlock>
...
8010209e:	e8 dd 25 00 00       	call   80104680 <acquire>
...
80102101:	e8 3a 20 00 00       	call   80104140 <wakeup>
...
8010211f:	e8 1c 26 00 00       	call   80104740 <release>
...
8010213e:	e8 ad 23 00 00       	call   801044f0 <holdingsleep>
...
80102178:	e8 03 25 00 00       	call   80104680 <acquire>
...
801021c9:	e8 b2 1d 00 00       	call   80103f80 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021e5:	c9                   	leave  
  release(&idelock);
801021e6:	e9 55 25 00 00       	jmp    80104740 <release>
801021eb:	90                   	nop
...
80102352:	e8 39 24 00 00       	call   80104790 <memset>
...
8010238a:	c9                   	leave  
    release(&kmem.lock);
8010238b:	e9 b0 23 00 00       	jmp    80104740 <release>
    acquire(&kmem.lock);
80102390:	83 ec 0c             	sub    $0xc,%esp
80102393:	68 40 26 11 80       	push   $0x80112640
80102398:	e8 e3 22 00 00       	call   80104680 <acquire>
...
80102503:	e8 78 21 00 00       	call   80104680 <acquire>
  r = kmem.freelist;
...
80102531:	e8 0a 22 00 00       	call   80104740 <release>
  return (char*)r;
...
80102947:	e8 94 1e 00 00       	call   801047e0 <memcmp>
...
80102a74:	e8 c7 1d 00 00       	call   80104840 <memmove>
...
80102b24:	e8 17 1a 00 00       	call   80104540 <initlock>
  readsb(dev, &sb);
80102b29:	58                   	pop    %eax
...
80102bbb:	e8 c0 1a 00 00       	call   80104680 <acquire>
...
80102bd5:	e8 a6 13 00 00       	call   80103f80 <sleep>
...
80102c0c:	e8 2f 1b 00 00       	call   80104740 <release>
      break;
    }
  }
}
...
80102c2e:	e8 4d 1a 00 00       	call   80104680 <acquire>
  log.outstanding -= 1;
...
80102c6c:	e8 cf 1a 00 00       	call   80104740 <release>
}
...
80102cc6:	e8 75 1b 00 00       	call   80104840 <memmove>
...
80102d0f:	e8 6c 19 00 00       	call   80104680 <acquire>
    wakeup(&log);
...
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 16 14 00 00       	call   80104140 <wakeup>
    release(&log.lock);
80102d2a:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d31:	e8 0a 1a 00 00       	call   80104740 <release>
...
80102d50:	e8 eb 13 00 00       	call   80104140 <wakeup>
  release(&log.lock);
80102d55:	c7 04 24 80 26 11 80 	movl   $0x80112680,(%esp)
80102d5c:	e8 df 19 00 00       	call   80104740 <release>
...
80102dbe:	e8 bd 18 00 00       	call   80104680 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102e0c:	c9                   	leave  
  release(&log.lock);
80102e0d:	e9 2e 19 00 00       	jmp    80104740 <release>
...
80102e72:	e8 79 2c 00 00       	call   80105af0 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 45 3d 00 00       	call   80106be0 <switchkvm>
  seginit();
80102e9b:	e8 b0 3c 00 00       	call   80106b50 <seginit>
  lapicinit();
...
80102ed1:	e8 da 41 00 00       	call   801070b0 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 6b 3c 00 00       	call   80106b50 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 27 2f 00 00       	call   80105e20 <uartinit>
  pinit();         // process table
80102ef9:	e8 42 08 00 00       	call   80103740 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 6d 2b 00 00       	call   80105a70 <tvinit>
  binit();         // buffer cache
...
80102f24:	e8 17 19 00 00       	call   80104840 <memmove>
...
80103004:	e8 d7 17 00 00       	call   801047e0 <memcmp>
...
801030c2:	e8 19 17 00 00       	call   801047e0 <memcmp>
...
80103203:	68 dd 77 10 80       	push   $0x801077dd
80103208:	e8 83 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010320d:	83 ec 0c             	sub    $0xc,%esp
80103210:	68 fc 77 10 80       	push   $0x801077fc
...
80103308:	00 00 00 
  initlock(&p->lock, "pipe");
8010330b:	68 30 78 10 80       	push   $0x80107830
80103310:	50                   	push   %eax
80103311:	e8 2a 12 00 00       	call   80104540 <initlock>
  (*f0)->type = FD_PIPE;
...
8010336f:	e8 0c 13 00 00       	call   80104680 <acquire>
  if(writable){
...
8010338f:	e8 ac 0d 00 00       	call   80104140 <wakeup>
...
801033b3:	5d                   	pop    %ebp
    release(&p->lock);
801033b4:	e9 87 13 00 00       	jmp    80104740 <release>
...
801033d4:	e8 67 0d 00 00       	call   80104140 <wakeup>
...
801033e4:	e8 57 13 00 00       	call   80104740 <release>
    kfree((char*)p);
...
8010340d:	e8 6e 12 00 00       	call   80104680 <acquire>
  for(i = 0; i < n; i++){
...
80103464:	e8 d7 0c 00 00       	call   80104140 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103469:	5a                   	pop    %edx
8010346a:	59                   	pop    %ecx
8010346b:	53                   	push   %ebx
8010346c:	56                   	push   %esi
8010346d:	e8 0e 0b 00 00       	call   80103f80 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103499:	8b 40 2c             	mov    0x2c(%eax),%eax
8010349c:	85 c0                	test   %eax,%eax
8010349e:	74 c0                	je     80103460 <pipewrite+0x60>
        release(&p->lock);
801034a0:	83 ec 0c             	sub    $0xc,%esp
801034a3:	53                   	push   %ebx
801034a4:	e8 97 12 00 00       	call   80104740 <release>
        return -1;
...
801034f3:	e8 48 0c 00 00       	call   80104140 <wakeup>
  release(&p->lock);
801034f8:	89 1c 24             	mov    %ebx,(%esp)
801034fb:	e8 40 12 00 00       	call   80104740 <release>
  return n;
...
80103520:	e8 5b 11 00 00       	call   80104680 <acquire>
...
80103555:	e8 26 0a 00 00       	call   80103f80 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010357e:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
8010358e:	e8 ad 11 00 00       	call   80104740 <release>
      return -1;
...
801035e7:	e8 54 0b 00 00       	call   80104140 <wakeup>
  release(&p->lock);
801035ec:	89 34 24             	mov    %esi,(%esp)
801035ef:	e8 4c 11 00 00       	call   80104740 <release>
  return i;
...
80103621:	e8 5a 10 00 00       	call   80104680 <acquire>
...
8010363c:	0f 83 7e 00 00 00    	jae    801036c0 <allocproc+0xb0>
    if(p->state == UNUSED)
80103642:	8b 43 14             	mov    0x14(%ebx),%eax
...
8010364e:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
80103651:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->nice = 20;
80103658:	c7 03 14 00 00 00    	movl   $0x14,(%ebx)
  p->pid = nextpid++;
8010365e:	8d 50 01             	lea    0x1(%eax),%edx
80103661:	89 43 18             	mov    %eax,0x18(%ebx)
  release(&ptable.lock);
80103664:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
80103669:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
8010366f:	e8 cc 10 00 00       	call   80104740 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103674:	e8 57 ee ff ff       	call   801024d0 <kalloc>
80103679:	83 c4 10             	add    $0x10,%esp
8010367c:	85 c0                	test   %eax,%eax
8010367e:	89 43 10             	mov    %eax,0x10(%ebx)
80103681:	74 56                	je     801036d9 <allocproc+0xc9>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
80103683:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103689:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
8010368c:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103691:	89 53 20             	mov    %edx,0x20(%ebx)
  *(uint*)sp = (uint)trapret;
80103694:	c7 40 14 61 5a 10 80 	movl   $0x80105a61,0x14(%eax)
  p->context = (struct context*)sp;
8010369b:	89 43 24             	mov    %eax,0x24(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010369e:	6a 14                	push   $0x14
801036a0:	6a 00                	push   $0x0
801036a2:	50                   	push   %eax
801036a3:	e8 e8 10 00 00       	call   80104790 <memset>
  p->context->eip = (uint)forkret;
801036a8:	8b 43 24             	mov    0x24(%ebx),%eax

  return p;
801036ab:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
801036ae:	c7 40 10 f0 36 10 80 	movl   $0x801036f0,0x10(%eax)
}
801036b5:	89 d8                	mov    %ebx,%eax
801036b7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801036ba:	c9                   	leave  
801036bb:	c3                   	ret    
...
801036ca:	e8 71 10 00 00       	call   80104740 <release>
}
...
801036d8:	c3                   	ret    
    p->state = UNUSED;
801036d9:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return 0;
801036e0:	31 db                	xor    %ebx,%ebx
801036e2:	eb d1                	jmp    801036b5 <allocproc+0xa5>
...
801036fb:	e8 40 10 00 00       	call   80104740 <release>
...
80103746:	68 35 78 10 80       	push   $0x80107835
8010374b:	68 20 2d 11 80       	push   $0x80112d20
80103750:	e8 eb 0d 00 00       	call   80104540 <initlock>
}
...
801037c0:	68 3c 78 10 80       	push   $0x8010783c
801037c5:	e8 c6 cb ff ff       	call   80100390 <panic>
    panic("mycpu called with interrupts enabled\n");
801037ca:	83 ec 0c             	sub    $0xc,%esp
801037cd:	68 40 79 10 80       	push   $0x80107940
...
80103804:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103807:	e8 a4 0d 00 00       	call   801045b0 <pushcli>
  c = mycpu();
8010380c:	e8 4f ff ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103811:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103817:	e8 d4 0d 00 00       	call   801045f0 <popcli>
}
...
80103843:	e8 e8 37 00 00       	call   80107030 <setupkvm>
80103848:	85 c0                	test   %eax,%eax
8010384a:	89 43 0c             	mov    %eax,0xc(%ebx)
8010384d:	0f 84 be 00 00 00    	je     80103911 <userinit+0xe1>
...
80103861:	e8 aa 34 00 00       	call   80106d10 <inituvm>
  memset(p->tf, 0, sizeof(*p->tf));
80103866:	83 c4 0c             	add    $0xc,%esp
  p->sz = PGSIZE;
80103869:	c7 43 08 00 10 00 00 	movl   $0x1000,0x8(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
80103870:	6a 4c                	push   $0x4c
80103872:	6a 00                	push   $0x0
80103874:	ff 73 20             	pushl  0x20(%ebx)
80103877:	e8 14 0f 00 00       	call   80104790 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010387c:	8b 43 20             	mov    0x20(%ebx),%eax
8010387f:	ba 1b 00 00 00       	mov    $0x1b,%edx
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103884:	b9 23 00 00 00       	mov    $0x23,%ecx
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103889:	83 c4 0c             	add    $0xc,%esp
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
8010388c:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103890:	8b 43 20             	mov    0x20(%ebx),%eax
80103893:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103897:	8b 43 20             	mov    0x20(%ebx),%eax
8010389a:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
8010389e:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
801038a2:	8b 43 20             	mov    0x20(%ebx),%eax
801038a5:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
801038a9:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
801038ad:	8b 43 20             	mov    0x20(%ebx),%eax
801038b0:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = PGSIZE;
801038b7:	8b 43 20             	mov    0x20(%ebx),%eax
801038ba:	c7 40 44 00 10 00 00 	movl   $0x1000,0x44(%eax)
  p->tf->eip = 0;  // beginning of initcode.S
801038c1:	8b 43 20             	mov    0x20(%ebx),%eax
801038c4:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
801038cb:	8d 43 74             	lea    0x74(%ebx),%eax
801038ce:	6a 10                	push   $0x10
801038d0:	68 65 78 10 80       	push   $0x80107865
801038d5:	50                   	push   %eax
801038d6:	e8 95 10 00 00       	call   80104970 <safestrcpy>
  p->cwd = namei("/");
801038db:	c7 04 24 6e 78 10 80 	movl   $0x8010786e,(%esp)
801038e2:	e8 09 e6 ff ff       	call   80101ef0 <namei>
801038e7:	89 43 70             	mov    %eax,0x70(%ebx)
  acquire(&ptable.lock);
801038ea:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801038f1:	e8 8a 0d 00 00       	call   80104680 <acquire>
  p->state = RUNNABLE;
801038f6:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  release(&ptable.lock);
801038fd:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103904:	e8 37 0e 00 00       	call   80104740 <release>
}
...
80103914:	68 4c 78 10 80       	push   $0x8010784c
80103919:	e8 72 ca ff ff       	call   80100390 <panic>
...
80103925:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103928:	e8 83 0c 00 00       	call   801045b0 <pushcli>
  c = mycpu();
8010392d:	e8 2e fe ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103932:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103938:	e8 b3 0c 00 00       	call   801045f0 <popcli>
  if(n > 0){
8010393d:	83 fe 00             	cmp    $0x0,%esi
  sz = curproc->sz;
80103940:	8b 43 08             	mov    0x8(%ebx),%eax
  if(n > 0){
80103943:	7f 1b                	jg     80103960 <growproc+0x40>
  } else if(n < 0){
80103945:	75 39                	jne    80103980 <growproc+0x60>
  switchuvm(curproc);
...
8010394e:	e8 ad 32 00 00       	call   80106c00 <switchuvm>
  return 0;
80103953:	83 c4 10             	add    $0x10,%esp
80103956:	31 c0                	xor    %eax,%eax
}
...
80103967:	ff 73 0c             	pushl  0xc(%ebx)
8010396a:	e8 e1 34 00 00       	call   80106e50 <allocuvm>
8010396f:	83 c4 10             	add    $0x10,%esp
80103972:	85 c0                	test   %eax,%eax
80103974:	75 d1                	jne    80103947 <growproc+0x27>
      return -1;
80103976:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010397b:	eb db                	jmp    80103958 <growproc+0x38>
...
80103987:	ff 73 0c             	pushl  0xc(%ebx)
8010398a:	e8 f1 35 00 00       	call   80106f80 <deallocuvm>
8010398f:	83 c4 10             	add    $0x10,%esp
80103992:	85 c0                	test   %eax,%eax
80103994:	75 b1                	jne    80103947 <growproc+0x27>
...
801039a6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039a9:	e8 02 0c 00 00       	call   801045b0 <pushcli>
  c = mycpu();
801039ae:	e8 ad fd ff ff       	call   80103760 <mycpu>
  p = c->proc;
801039b3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b9:	e8 32 0c 00 00       	call   801045f0 <popcli>
  if((np = allocproc()) == 0){
801039be:	e8 4d fc ff ff       	call   80103610 <allocproc>
801039c3:	85 c0                	test   %eax,%eax
801039c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801039c8:	0f 84 c7 00 00 00    	je     80103a95 <fork+0xf5>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
801039ce:	83 ec 08             	sub    $0x8,%esp
801039d1:	ff 73 08             	pushl  0x8(%ebx)
801039d4:	ff 73 0c             	pushl  0xc(%ebx)
801039d7:	89 c7                	mov    %eax,%edi
801039d9:	e8 22 37 00 00       	call   80107100 <copyuvm>
801039de:	83 c4 10             	add    $0x10,%esp
801039e1:	85 c0                	test   %eax,%eax
801039e3:	89 47 0c             	mov    %eax,0xc(%edi)
801039e6:	0f 84 b0 00 00 00    	je     80103a9c <fork+0xfc>
  np->sz = curproc->sz;
801039ec:	8b 43 08             	mov    0x8(%ebx),%eax
801039ef:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
801039f2:	89 41 08             	mov    %eax,0x8(%ecx)
  np->nice = 20;
801039f5:	c7 01 14 00 00 00    	movl   $0x14,(%ecx)
801039fb:	89 c8                	mov    %ecx,%eax
  np->parent = curproc;
801039fd:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  *np->tf = *curproc->tf;
80103a00:	8b 79 20             	mov    0x20(%ecx),%edi
80103a03:	b9 13 00 00 00       	mov    $0x13,%ecx
80103a08:	8b 73 20             	mov    0x20(%ebx),%esi
80103a0b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103a0d:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103a0f:	8b 40 20             	mov    0x20(%eax),%eax
80103a12:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
80103a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103a20:	8b 44 b3 30          	mov    0x30(%ebx,%esi,4),%eax
...
80103a37:	89 44 b2 30          	mov    %eax,0x30(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
...
80103a46:	ff 73 70             	pushl  0x70(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a49:	83 c3 74             	add    $0x74,%ebx
  np->cwd = idup(curproc->cwd);
...
80103a9a:	eb ef                	jmp    80103a8b <fork+0xeb>
    kfree(np->kstack);
80103a9c:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103a9f:	83 ec 0c             	sub    $0xc,%esp
80103aa2:	ff 73 10             	pushl  0x10(%ebx)
80103aa5:	e8 76 e8 ff ff       	call   80102320 <kfree>
    np->kstack = 0;
80103aaa:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    np->state = UNUSED;
80103ab1:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return -1;
80103ab8:	83 c4 10             	add    $0x10,%esp
80103abb:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103ac0:	eb c9                	jmp    80103a8b <fork+0xeb>
...
80103adc:	81 ec 2c 01 00 00    	sub    $0x12c,%esp
  struct cpu *c = mycpu();
80103ae2:	e8 79 fc ff ff       	call   80103760 <mycpu>
80103ae7:	89 85 d8 fe ff ff    	mov    %eax,-0x128(%ebp)
80103aed:	83 c0 04             	add    $0x4,%eax
80103af0:	89 85 d4 fe ff ff    	mov    %eax,-0x12c(%ebp)
  asm volatile("sti");
80103af6:	fb                   	sti    
...
80103af9:	83 ec 0c             	sub    $0xc,%esp
    int complete_p[NPROC] = {0,};
80103afc:	b9 40 00 00 00       	mov    $0x40,%ecx
80103b01:	89 f7                	mov    %esi,%edi
80103b03:	f3 ab                	rep stos %eax,%es:(%edi)
    acquire(&ptable.lock);
80103b05:	68 20 2d 11 80       	push   $0x80112d20
    int ind = 0;
80103b0a:	31 ff                	xor    %edi,%edi
    acquire(&ptable.lock);
80103b0c:	e8 6f 0b 00 00       	call   80104680 <acquire>
80103b11:	83 c4 10             	add    $0x10,%esp
    struct proc *hp = 0;
80103b14:	31 c9                	xor    %ecx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b16:	c7 85 e0 fe ff ff 54 	movl   $0x80112d54,-0x120(%ebp)
80103b1d:	2d 11 80 
80103b20:	eb 21                	jmp    80103b43 <scheduler+0x73>
80103b22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103b28:	81 85 e0 fe ff ff 84 	addl   $0x84,-0x120(%ebp)
80103b2f:	00 00 00 
80103b32:	8b 85 e0 fe ff ff    	mov    -0x120(%ebp),%eax
80103b38:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103b3d:	0f 83 58 01 00 00    	jae    80103c9b <scheduler+0x1cb>
      if(p->state != RUNNABLE)
80103b43:	8b 85 e0 fe ff ff    	mov    -0x120(%ebp),%eax
80103b49:	83 78 14 03          	cmpl   $0x3,0x14(%eax)
80103b4d:	75 d9                	jne    80103b28 <scheduler+0x58>
		      if(complete_p[i] == tmp1->pid){
80103b4f:	8b 85 e8 fe ff ff    	mov    -0x118(%ebp),%eax
      for(tmp1 = ptable.proc; tmp1 < &ptable.proc[NPROC]; tmp1++){
80103b55:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
		      if(complete_p[i] == tmp1->pid){
80103b5a:	89 85 dc fe ff ff    	mov    %eax,-0x124(%ebp)
	      if(tmp1->state != RUNNABLE)
80103b60:	83 7a 14 03          	cmpl   $0x3,0x14(%edx)
80103b64:	0f 84 fe 00 00 00    	je     80103c68 <scheduler+0x198>
      for(tmp1 = ptable.proc; tmp1 < &ptable.proc[NPROC]; tmp1++){
80103b6a:	81 c2 84 00 00 00    	add    $0x84,%edx
80103b70:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103b76:	72 e8                	jb     80103b60 <scheduler+0x90>
80103b78:	89 8d e0 fe ff ff    	mov    %ecx,-0x120(%ebp)
80103b7e:	66 90                	xchg   %ax,%ax
80103b80:	8b 85 e0 fe ff ff    	mov    -0x120(%ebp),%eax
80103b86:	8b 00                	mov    (%eax),%eax
80103b88:	89 85 e4 fe ff ff    	mov    %eax,-0x11c(%ebp)
80103b8e:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103b93:	eb 0f                	jmp    80103ba4 <scheduler+0xd4>
80103b95:	8d 76 00             	lea    0x0(%esi),%esi
      for(tmp2 = ptable.proc; tmp2 < &ptable.proc[NPROC]; tmp2++){
80103b98:	05 84 00 00 00       	add    $0x84,%eax
80103b9d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103ba2:	73 54                	jae    80103bf8 <scheduler+0x128>
	      if(tmp2->state != RUNNABLE)
80103ba4:	83 78 14 03          	cmpl   $0x3,0x14(%eax)
80103ba8:	75 ee                	jne    80103b98 <scheduler+0xc8>
	      if(hp->nice < tmp2->nice){
80103baa:	8b 18                	mov    (%eax),%ebx
80103bac:	3b 9d e4 fe ff ff    	cmp    -0x11c(%ebp),%ebx
80103bb2:	7e e4                	jle    80103b98 <scheduler+0xc8>
		      for(int i = 0; i < ind; i++){
80103bb4:	85 ff                	test   %edi,%edi
80103bb6:	74 24                	je     80103bdc <scheduler+0x10c>
			      if(complete_p[i] == tmp2->pid){
80103bb8:	8b 48 18             	mov    0x18(%eax),%ecx
80103bbb:	3b 8d dc fe ff ff    	cmp    -0x124(%ebp),%ecx
80103bc1:	74 d5                	je     80103b98 <scheduler+0xc8>
		      for(int i = 0; i < ind; i++){
80103bc3:	31 d2                	xor    %edx,%edx
80103bc5:	eb 0e                	jmp    80103bd5 <scheduler+0x105>
80103bc7:	89 f6                	mov    %esi,%esi
80103bc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
			      if(complete_p[i] == tmp2->pid){
80103bd0:	39 0c 96             	cmp    %ecx,(%esi,%edx,4)
80103bd3:	74 c3                	je     80103b98 <scheduler+0xc8>
		      for(int i = 0; i < ind; i++){
80103bd5:	83 c2 01             	add    $0x1,%edx
80103bd8:	39 fa                	cmp    %edi,%edx
80103bda:	75 f4                	jne    80103bd0 <scheduler+0x100>
80103bdc:	89 85 e0 fe ff ff    	mov    %eax,-0x120(%ebp)
      for(tmp2 = ptable.proc; tmp2 < &ptable.proc[NPROC]; tmp2++){
80103be2:	05 84 00 00 00       	add    $0x84,%eax
		      for(int i = 0; i < ind; i++){
80103be7:	89 9d e4 fe ff ff    	mov    %ebx,-0x11c(%ebp)
      for(tmp2 = ptable.proc; tmp2 < &ptable.proc[NPROC]; tmp2++){
80103bed:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103bf2:	72 b0                	jb     80103ba4 <scheduler+0xd4>
80103bf4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      complete_p[ind] = p->pid;
80103bf8:	8b 9d e0 fe ff ff    	mov    -0x120(%ebp),%ebx
      switchuvm(p);
80103bfe:	83 ec 0c             	sub    $0xc,%esp
      complete_p[ind] = p->pid;
80103c01:	8b 43 18             	mov    0x18(%ebx),%eax
80103c04:	89 84 bd e8 fe ff ff 	mov    %eax,-0x118(%ebp,%edi,4)
      p->timeslice = p->nice;
80103c0b:	89 d8                	mov    %ebx,%eax
80103c0d:	8b 9d e4 fe ff ff    	mov    -0x11c(%ebp),%ebx
      ind += 1;
80103c13:	83 c7 01             	add    $0x1,%edi
      p->timeslice = p->nice;
80103c16:	89 58 04             	mov    %ebx,0x4(%eax)
      c->proc = p;
80103c19:	8b 9d d8 fe ff ff    	mov    -0x128(%ebp),%ebx
80103c1f:	89 83 ac 00 00 00    	mov    %eax,0xac(%ebx)
      switchuvm(p);
80103c25:	50                   	push   %eax
80103c26:	89 c3                	mov    %eax,%ebx
80103c28:	e8 d3 2f 00 00       	call   80106c00 <switchuvm>
      p->state = RUNNING;
80103c2d:	c7 43 14 04 00 00 00 	movl   $0x4,0x14(%ebx)
      swtch(&(c->scheduler), p->context);
80103c34:	58                   	pop    %eax
80103c35:	5a                   	pop    %edx
80103c36:	ff 73 24             	pushl  0x24(%ebx)
80103c39:	ff b5 d4 fe ff ff    	pushl  -0x12c(%ebp)
80103c3f:	e8 87 0d 00 00       	call   801049cb <swtch>
      switchkvm();
80103c44:	e8 97 2f 00 00       	call   80106be0 <switchkvm>
      c->proc = 0;
80103c49:	8b 85 d8 fe ff ff    	mov    -0x128(%ebp),%eax
80103c4f:	83 c4 10             	add    $0x10,%esp
80103c52:	89 d9                	mov    %ebx,%ecx
80103c54:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103c5b:	00 00 00 
80103c5e:	e9 c5 fe ff ff       	jmp    80103b28 <scheduler+0x58>
80103c63:	90                   	nop
80103c64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	      for(int i = 0; i < ind; i++){
80103c68:	85 ff                	test   %edi,%edi
80103c6a:	74 24                	je     80103c90 <scheduler+0x1c0>
		      if(complete_p[i] == tmp1->pid){
80103c6c:	8b 5a 18             	mov    0x18(%edx),%ebx
80103c6f:	3b 9d dc fe ff ff    	cmp    -0x124(%ebp),%ebx
80103c75:	0f 84 ef fe ff ff    	je     80103b6a <scheduler+0x9a>
	      for(int i = 0; i < ind; i++){
80103c7b:	31 c0                	xor    %eax,%eax
80103c7d:	eb 0a                	jmp    80103c89 <scheduler+0x1b9>
80103c7f:	90                   	nop
		      if(complete_p[i] == tmp1->pid){
80103c80:	39 1c 86             	cmp    %ebx,(%esi,%eax,4)
80103c83:	0f 84 e1 fe ff ff    	je     80103b6a <scheduler+0x9a>
	      for(int i = 0; i < ind; i++){
80103c89:	83 c0 01             	add    $0x1,%eax
80103c8c:	39 f8                	cmp    %edi,%eax
80103c8e:	75 f0                	jne    80103c80 <scheduler+0x1b0>
80103c90:	89 95 e0 fe ff ff    	mov    %edx,-0x120(%ebp)
80103c96:	e9 e5 fe ff ff       	jmp    80103b80 <scheduler+0xb0>
    release(&ptable.lock);
80103c9b:	83 ec 0c             	sub    $0xc,%esp
80103c9e:	68 20 2d 11 80       	push   $0x80112d20
80103ca3:	e8 98 0a 00 00       	call   80104740 <release>
  for(;;){
80103ca8:	83 c4 10             	add    $0x10,%esp
80103cab:	e9 46 fe ff ff       	jmp    80103af6 <scheduler+0x26>
...
80103cb4:	53                   	push   %ebx
  pushcli();
80103cb5:	e8 f6 08 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103cba:	e8 a1 fa ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103cbf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103cc5:	e8 26 09 00 00       	call   801045f0 <popcli>
...
80103cea:	75 68                	jne    80103d54 <sched+0xa4>
  if(p->state == RUNNING)
80103cec:	83 7b 14 04          	cmpl   $0x4,0x14(%ebx)
...
80103cfe:	83 c3 24             	add    $0x24,%ebx
  intena = mycpu()->intena;
80103d01:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d07:	e8 54 fa ff ff       	call   80103760 <mycpu>
80103d0c:	83 ec 08             	sub    $0x8,%esp
80103d0f:	ff 70 04             	pushl  0x4(%eax)
80103d12:	53                   	push   %ebx
80103d13:	e8 b3 0c 00 00       	call   801049cb <swtch>
  mycpu()->intena = intena;
80103d18:	e8 43 fa ff ff       	call   80103760 <mycpu>
}
...
80103d76:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d79:	e8 32 08 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103d7e:	e8 dd f9 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103d83:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d89:	e8 62 08 00 00       	call   801045f0 <popcli>
  if(curproc == initproc)
80103d8e:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103d94:	8d 5e 30             	lea    0x30(%esi),%ebx
80103d97:	8d 7e 70             	lea    0x70(%esi),%edi
...
80103dc7:	ff 76 70             	pushl  0x70(%esi)
80103dca:	e8 f1 d9 ff ff       	call   801017c0 <iput>
  end_op();
80103dcf:	e8 4c ee ff ff       	call   80102c20 <end_op>
  curproc->cwd = 0;
80103dd4:	c7 46 70 00 00 00 00 	movl   $0x0,0x70(%esi)
  acquire(&ptable.lock);
80103ddb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103de2:	e8 99 08 00 00       	call   80104680 <acquire>
  wakeup1(curproc->parent);
80103de7:	8b 56 1c             	mov    0x1c(%esi),%edx
...
80103dfd:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e02:	73 1e                	jae    80103e22 <exit+0xb2>
    if(p->state == SLEEPING && p->chan == chan)
80103e04:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
80103e08:	75 ee                	jne    80103df8 <exit+0x88>
80103e0a:	3b 50 28             	cmp    0x28(%eax),%edx
80103e0d:	75 e9                	jne    80103df8 <exit+0x88>
      p->state = RUNNABLE;
80103e0f:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e16:	05 84 00 00 00       	add    $0x84,%eax
80103e1b:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80103e36:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103e3c:	73 3a                	jae    80103e78 <exit+0x108>
    if(p->parent == curproc){
80103e3e:	39 72 1c             	cmp    %esi,0x1c(%edx)
80103e41:	75 ed                	jne    80103e30 <exit+0xc0>
      if(p->state == ZOMBIE)
80103e43:	83 7a 14 05          	cmpl   $0x5,0x14(%edx)
      p->parent = initproc;
80103e47:	89 4a 1c             	mov    %ecx,0x1c(%edx)
      if(p->state == ZOMBIE)
...
80103ea4:	53                   	push   %ebx
  pushcli();
80103ea5:	e8 06 07 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103eaa:	e8 b1 f8 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103eaf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103eb5:	e8 36 07 00 00       	call   801045f0 <popcli>
	int cur_slice = myproc()->timeslice;
80103eba:	8b 5b 04             	mov    0x4(%ebx),%ebx
	if(cur_slice){
80103ebd:	85 db                	test   %ebx,%ebx
80103ebf:	75 47                	jne    80103f08 <yield_if_timeslice_expired+0x68>
  		acquire(&ptable.lock); 
80103ec1:	83 ec 0c             	sub    $0xc,%esp
80103ec4:	68 20 2d 11 80       	push   $0x80112d20
80103ec9:	e8 b2 07 00 00       	call   80104680 <acquire>
  pushcli();
80103ece:	e8 dd 06 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103ed3:	e8 88 f8 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103ed8:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ede:	e8 0d 07 00 00       	call   801045f0 <popcli>
  		myproc()->state = RUNNABLE;
80103ee3:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  		sched();
80103eea:	e8 c1 fd ff ff       	call   80103cb0 <sched>
  		release(&ptable.lock);
80103eef:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ef6:	e8 45 08 00 00       	call   80104740 <release>
...
80103f05:	8d 76 00             	lea    0x0(%esi),%esi
  pushcli();
80103f08:	e8 a3 06 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103f0d:	e8 4e f8 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103f12:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
		myproc()->timeslice = cur_slice - 1;
80103f18:	83 eb 01             	sub    $0x1,%ebx
  popcli();
80103f1b:	e8 d0 06 00 00       	call   801045f0 <popcli>
		myproc()->timeslice = cur_slice - 1;
80103f20:	89 5e 04             	mov    %ebx,0x4(%esi)
}
...
80103f3c:	e8 3f 07 00 00       	call   80104680 <acquire>
  pushcli();
80103f41:	e8 6a 06 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103f46:	e8 15 f8 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103f4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f51:	e8 9a 06 00 00       	call   801045f0 <popcli>
  myproc()->state = RUNNABLE;
80103f56:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  sched();
80103f5d:	e8 4e fd ff ff       	call   80103cb0 <sched>
  release(&ptable.lock);
80103f62:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103f69:	e8 d2 07 00 00       	call   80104740 <release>
}
...
80103f8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f8f:	e8 1c 06 00 00       	call   801045b0 <pushcli>
  c = mycpu();
80103f94:	e8 c7 f7 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103f99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f9f:	e8 4c 06 00 00       	call   801045f0 <popcli>
  if(p == 0)
...
80103fb0:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103fb6:	74 50                	je     80104008 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103fb8:	83 ec 0c             	sub    $0xc,%esp
80103fbb:	68 20 2d 11 80       	push   $0x80112d20
80103fc0:	e8 bb 06 00 00       	call   80104680 <acquire>
    release(lk);
80103fc5:	89 34 24             	mov    %esi,(%esp)
80103fc8:	e8 73 07 00 00       	call   80104740 <release>
  p->chan = chan;
80103fcd:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
80103fd0:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
80103fd7:	e8 d4 fc ff ff       	call   80103cb0 <sched>
  p->chan = 0;
80103fdc:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
    release(&ptable.lock);
80103fe3:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103fea:	e8 51 07 00 00       	call   80104740 <release>
    acquire(lk);
...
80103ffb:	5d                   	pop    %ebp
    acquire(lk);
80103ffc:	e9 7f 06 00 00       	jmp    80104680 <acquire>
80104001:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104008:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
8010400b:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
80104012:	e8 99 fc ff ff       	call   80103cb0 <sched>
  p->chan = 0;
80104017:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
}
...
80104029:	68 cf 78 10 80       	push   $0x801078cf
8010402e:	e8 5d c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80104033:	83 ec 0c             	sub    $0xc,%esp
80104036:	68 c9 78 10 80       	push   $0x801078c9
...
80104044:	53                   	push   %ebx
  pushcli();
80104045:	e8 66 05 00 00       	call   801045b0 <pushcli>
  c = mycpu();
8010404a:	e8 11 f7 ff ff       	call   80103760 <mycpu>
  p = c->proc;
8010404f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104055:	e8 96 05 00 00       	call   801045f0 <popcli>
  acquire(&ptable.lock);
8010405a:	83 ec 0c             	sub    $0xc,%esp
8010405d:	68 20 2d 11 80       	push   $0x80112d20
80104062:	e8 19 06 00 00       	call   80104680 <acquire>
80104067:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010406a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010406c:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104071:	eb 13                	jmp    80104086 <wait+0x46>
80104073:	90                   	nop
80104074:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104078:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010407e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104084:	73 1e                	jae    801040a4 <wait+0x64>
      if(p->parent != curproc)
80104086:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80104089:	75 ed                	jne    80104078 <wait+0x38>
      if(p->state == ZOMBIE){
8010408b:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
8010408f:	74 37                	je     801040c8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104091:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80104097:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010409c:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
801040a2:	72 e2                	jb     80104086 <wait+0x46>
    if(!havekids || curproc->killed){
801040a4:	85 c0                	test   %eax,%eax
801040a6:	74 76                	je     8010411e <wait+0xde>
801040a8:	8b 46 2c             	mov    0x2c(%esi),%eax
801040ab:	85 c0                	test   %eax,%eax
801040ad:	75 6f                	jne    8010411e <wait+0xde>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801040af:	83 ec 08             	sub    $0x8,%esp
801040b2:	68 20 2d 11 80       	push   $0x80112d20
801040b7:	56                   	push   %esi
801040b8:	e8 c3 fe ff ff       	call   80103f80 <sleep>
    havekids = 0;
801040bd:	83 c4 10             	add    $0x10,%esp
801040c0:	eb a8                	jmp    8010406a <wait+0x2a>
801040c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
801040c8:	83 ec 0c             	sub    $0xc,%esp
801040cb:	ff 73 10             	pushl  0x10(%ebx)
        pid = p->pid;
801040ce:	8b 73 18             	mov    0x18(%ebx),%esi
        kfree(p->kstack);
801040d1:	e8 4a e2 ff ff       	call   80102320 <kfree>
        freevm(p->pgdir);
801040d6:	5a                   	pop    %edx
801040d7:	ff 73 0c             	pushl  0xc(%ebx)
        p->kstack = 0;
801040da:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
801040e1:	e8 ca 2e 00 00       	call   80106fb0 <freevm>
        release(&ptable.lock);
801040e6:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
801040ed:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
801040f4:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
801040fb:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
801040ff:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
        p->state = UNUSED;
80104106:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
8010410d:	e8 2e 06 00 00       	call   80104740 <release>
        return pid;
...
8010414f:	e8 2c 05 00 00       	call   80104680 <acquire>
...
80104165:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010416a:	73 1e                	jae    8010418a <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010416c:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
80104170:	75 ee                	jne    80104160 <wakeup+0x20>
80104172:	3b 58 28             	cmp    0x28(%eax),%ebx
80104175:	75 e9                	jne    80104160 <wakeup+0x20>
      p->state = RUNNABLE;
80104177:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010417e:	05 84 00 00 00       	add    $0x84,%eax
80104183:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
...
80104194:	c9                   	leave  
  release(&ptable.lock);
80104195:	e9 a6 05 00 00       	jmp    80104740 <release>
...
801041af:	e8 cc 04 00 00       	call   80104680 <acquire>
...
801041c5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
801041ca:	73 34                	jae    80104200 <kill+0x60>
    if(p->pid == pid){
801041cc:	39 58 18             	cmp    %ebx,0x18(%eax)
801041cf:	75 ef                	jne    801041c0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801041d1:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
      p->killed = 1;
801041d5:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
      if(p->state == SLEEPING)
801041dc:	75 07                	jne    801041e5 <kill+0x45>
        p->state = RUNNABLE;
801041de:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
      release(&ptable.lock);
801041e5:	83 ec 0c             	sub    $0xc,%esp
801041e8:	68 20 2d 11 80       	push   $0x80112d20
801041ed:	e8 4e 05 00 00       	call   80104740 <release>
      return 0;
...
80104208:	e8 33 05 00 00       	call   80104740 <release>
  return -1;
...
8010423b:	68 93 7c 10 80       	push   $0x80107c93
80104240:	e8 1b c4 ff ff       	call   80100660 <cprintf>
80104245:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104248:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010424e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104254:	0f 83 86 00 00 00    	jae    801042e0 <procdump+0xc0>
    if(p->state == UNUSED)
8010425a:	8b 43 14             	mov    0x14(%ebx),%eax
8010425d:	85 c0                	test   %eax,%eax
8010425f:	74 e7                	je     80104248 <procdump+0x28>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104261:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104264:	ba e0 78 10 80       	mov    $0x801078e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104269:	77 11                	ja     8010427c <procdump+0x5c>
8010426b:	8b 14 85 68 79 10 80 	mov    -0x7fef8698(,%eax,4),%edx
      state = "???";
80104272:	b8 e0 78 10 80       	mov    $0x801078e0,%eax
80104277:	85 d2                	test   %edx,%edx
80104279:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
8010427c:	8d 43 74             	lea    0x74(%ebx),%eax
8010427f:	50                   	push   %eax
80104280:	52                   	push   %edx
80104281:	ff 73 18             	pushl  0x18(%ebx)
80104284:	68 e4 78 10 80       	push   $0x801078e4
80104289:	e8 d2 c3 ff ff       	call   80100660 <cprintf>
    if(p->state == SLEEPING){
8010428e:	83 c4 10             	add    $0x10,%esp
80104291:	83 7b 14 02          	cmpl   $0x2,0x14(%ebx)
...
801042a1:	8b 43 24             	mov    0x24(%ebx),%eax
801042a4:	8b 40 0c             	mov    0xc(%eax),%eax
801042a7:	83 c0 08             	add    $0x8,%eax
801042aa:	50                   	push   %eax
801042ab:	e8 b0 02 00 00       	call   80104560 <getcallerpcs>
...
801042c9:	68 21 73 10 80       	push   $0x80107321
...
801042f0:	55                   	push   %ebp
 ...
 for( p = ptable.proc ; p < &ptable.proc[NPROC] ; p++){
801042f1:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
{
801042f6:	89 e5                	mov    %esp,%ebp
801042f8:	53                   	push   %ebx
 int num = 0;
801042f9:	31 db                	xor    %ebx,%ebx
{
801042fb:	83 ec 04             	sub    $0x4,%esp
801042fe:	66 90                	xchg   %ax,%ax
  if( p ->state != UNUSED)
	num++;
80104300:	83 7a 14 01          	cmpl   $0x1,0x14(%edx)
80104304:	83 db ff             	sbb    $0xffffffff,%ebx
 for( p = ptable.proc ; p < &ptable.proc[NPROC] ; p++){
80104307:	81 c2 84 00 00 00    	add    $0x84,%edx
8010430d:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104313:	72 eb                	jb     80104300 <getnproc+0x10>
  }
  procdump();
80104315:	e8 06 ff ff ff       	call   80104220 <procdump>
  return num;
}
...
8010433b:	eb 0f                	jmp    8010434c <getnval+0x1c>
8010433d:	8d 76 00             	lea    0x0(%esi),%esi
	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104340:	05 84 00 00 00       	add    $0x84,%eax
80104345:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
8010434a:	73 0c                	jae    80104358 <getnval+0x28>
	    if(p->pid == pid){
8010434c:	39 50 18             	cmp    %edx,0x18(%eax)
8010434f:	75 ef                	jne    80104340 <getnval+0x10>
	      return p->nice;
80104351:	8b 00                	mov    (%eax),%eax
	    }
	  }
...
80104363:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104366:	8b 55 08             	mov    0x8(%ebp),%edx
	  if((val < 0) || (val > 40))
80104369:	83 f9 28             	cmp    $0x28,%ecx
8010436c:	77 29                	ja     80104397 <setnval+0x37>
		  return -2;

	  struct proc *p;

	  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010436e:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104373:	eb 0f                	jmp    80104384 <setnval+0x24>
80104375:	8d 76 00             	lea    0x0(%esi),%esi
80104378:	05 84 00 00 00       	add    $0x84,%eax
8010437d:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80104382:	73 0c                	jae    80104390 <setnval+0x30>
	    if(p->pid == pid){
80104384:	39 50 18             	cmp    %edx,0x18(%eax)
80104387:	75 ef                	jne    80104378 <setnval+0x18>
	      p->nice = val;
80104389:	89 08                	mov    %ecx,(%eax)
...
80104396:	c3                   	ret    
		  return -2;
80104397:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
}
8010439c:	5d                   	pop    %ebp
8010439d:	c3                   	ret    
...
801043a4:	53                   	push   %ebx
    ...
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
801043a5:	be e0 78 10 80       	mov    $0x801078e0,%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043aa:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  cprintf("PID STATE NAME NICE\n");
801043af:	83 ec 0c             	sub    $0xc,%esp
801043b2:	68 ed 78 10 80       	push   $0x801078ed
801043b7:	e8 a4 c2 ff ff       	call   80100660 <cprintf>
801043bc:	83 c4 10             	add    $0x10,%esp
801043bf:	90                   	nop
    if(p->state == UNUSED)
801043c0:	8b 43 14             	mov    0x14(%ebx),%eax
801043c3:	85 c0                	test   %eax,%eax
801043c5:	74 30                	je     801043f7 <psShow+0x57>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043c7:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801043ca:	ba e0 78 10 80       	mov    $0x801078e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801043cf:	77 0c                	ja     801043dd <psShow+0x3d>
801043d1:	8b 14 85 68 79 10 80 	mov    -0x7fef8698(,%eax,4),%edx
      state = "???";
801043d8:	85 d2                	test   %edx,%edx
801043da:	0f 44 d6             	cmove  %esi,%edx
    cprintf(" %d   %s   %s   %d\n", p->pid, state, p->name, p->nice);
801043dd:	8d 43 74             	lea    0x74(%ebx),%eax
801043e0:	83 ec 0c             	sub    $0xc,%esp
801043e3:	ff 33                	pushl  (%ebx)
801043e5:	50                   	push   %eax
801043e6:	52                   	push   %edx
801043e7:	ff 73 18             	pushl  0x18(%ebx)
801043ea:	68 02 79 10 80       	push   $0x80107902
801043ef:	e8 6c c2 ff ff       	call   80100660 <cprintf>
801043f4:	83 c4 20             	add    $0x20,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043f7:	81 c3 84 00 00 00    	add    $0x84,%ebx
801043fd:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104403:	72 bb                	jb     801043c0 <psShow+0x20>
  }
}
...
8010441a:	68 80 79 10 80       	push   $0x80107980
...
80104475:	e8 06 fb ff ff       	call   80103f80 <sleep>
  while (lk->locked) {
...
80104483:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104489:	e8 72 f3 ff ff       	call   80103800 <myproc>
...
801044d4:	e8 67 fc ff ff       	call   80104140 <wakeup>
  release(&lk->lk);
...
80104513:	e8 e8 f2 ff ff       	call   80103800 <myproc>
80104518:	39 58 18             	cmp    %ebx,0x18(%eax)
...
801045fb:	75 35                	jne    80104632 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801045fd:	e8 5e f1 ff ff       	call   80103760 <mycpu>
...
8010461c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104620:	e8 3b f1 ff ff       	call   80103760 <mycpu>
...
80104635:	68 8b 79 10 80       	push   $0x8010798b
8010463a:	e8 51 bd ff ff       	call   80100390 <panic>
    panic("popcli");
8010463f:	83 ec 0c             	sub    $0xc,%esp
80104642:	68 a2 79 10 80       	push   $0x801079a2
...
80104668:	e8 f3 f0 ff ff       	call   80103760 <mycpu>
...
801046c4:	e8 97 f0 ff ff       	call   80103760 <mycpu>
...
80104727:	68 a9 79 10 80       	push   $0x801079a9
...
8010477c:	68 b1 79 10 80       	push   $0x801079b1
...
801049e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049ea:	e8 11 ee ff ff       	call   80103800 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801049ef:	8b 40 08             	mov    0x8(%eax),%eax
801049f2:	39 d8                	cmp    %ebx,%eax
801049f4:	76 1a                	jbe    80104a10 <fetchint+0x30>
801049f6:	8d 53 04             	lea    0x4(%ebx),%edx
801049f9:	39 d0                	cmp    %edx,%eax
801049fb:	72 13                	jb     80104a10 <fetchint+0x30>
    return -1;
  *ip = *(int*)(addr);
801049fd:	8b 45 0c             	mov    0xc(%ebp),%eax
80104a00:	8b 13                	mov    (%ebx),%edx
...
80104a15:	eb ef                	jmp    80104a06 <fetchint+0x26>
...
80104a27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a2a:	e8 d1 ed ff ff       	call   80103800 <myproc>

  if(addr >= curproc->sz)
80104a2f:	39 58 08             	cmp    %ebx,0x8(%eax)
80104a32:	76 28                	jbe    80104a5c <fetchstr+0x3c>
    return -1;
  *pp = (char*)addr;
80104a34:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80104a37:	89 da                	mov    %ebx,%edx
80104a39:	89 19                	mov    %ebx,(%ecx)
  ep = (char*)curproc->sz;
80104a3b:	8b 40 08             	mov    0x8(%eax),%eax
  for(s = *pp; s < ep; s++){
80104a3e:	39 c3                	cmp    %eax,%ebx
80104a40:	73 1a                	jae    80104a5c <fetchstr+0x3c>
    if(*s == 0)
80104a42:	80 3b 00             	cmpb   $0x0,(%ebx)
80104a45:	75 0e                	jne    80104a55 <fetchstr+0x35>
80104a47:	eb 37                	jmp    80104a80 <fetchstr+0x60>
...
80104a95:	e8 66 ed ff ff       	call   80103800 <myproc>
...
80104aa3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104aa6:	e8 55 ed ff ff       	call   80103800 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104aab:	8b 40 08             	mov    0x8(%eax),%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104aae:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104ab1:	39 c6                	cmp    %eax,%esi
80104ab3:	73 1b                	jae    80104ad0 <argint+0x40>
80104ab5:	8d 53 08             	lea    0x8(%ebx),%edx
80104ab8:	39 d0                	cmp    %edx,%eax
80104aba:	72 14                	jb     80104ad0 <argint+0x40>
  *ip = *(int*)(addr);
80104abc:	8b 45 0c             	mov    0xc(%ebp),%eax
80104abf:	8b 53 04             	mov    0x4(%ebx),%edx
80104ac2:	89 10                	mov    %edx,(%eax)
  return 0;
...
80104ad0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ad5:	eb ef                	jmp    80104ac6 <argint+0x36>
...
80104ae8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104aeb:	e8 10 ed ff ff       	call   80103800 <myproc>
...
80104b0c:	8b 56 08             	mov    0x8(%esi),%edx
80104b0f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b12:	39 c2                	cmp    %eax,%edx
80104b14:	76 1a                	jbe    80104b30 <argptr+0x50>
80104b16:	01 c3                	add    %eax,%ebx
80104b18:	39 da                	cmp    %ebx,%edx
80104b1a:	72 14                	jb     80104b30 <argptr+0x50>
    return -1;
  *pp = (char*)i;
...
80104b35:	eb ec                	jmp    80104b23 <argptr+0x43>
...
80104b84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b87:	e8 74 ec ff ff       	call   80103800 <myproc>
80104b8c:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80104b8e:	8b 40 20             	mov    0x20(%eax),%eax
...
80104ba9:	8b 53 20             	mov    0x20(%ebx),%edx
...
80104bb8:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104bb9:	8d 43 74             	lea    0x74(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104bbc:	50                   	push   %eax
80104bbd:	ff 73 18             	pushl  0x18(%ebx)
80104bc0:	68 b9 79 10 80       	push   $0x801079b9
80104bc5:	e8 96 ba ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
80104bca:	8b 43 20             	mov    0x20(%ebx),%eax
...
80104d14:	68 68 7a 10 80       	push   $0x80107a68
...
80104d2c:	68 67 7a 10 80       	push   $0x80107a67
...
80104d45:	68 5b 7a 10 80       	push   $0x80107a5b
...
80104d5a:	68 6a 7a 10 80       	push   $0x80107a6a
80104d5f:	e8 2c b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104d64:	83 ec 0c             	sub    $0xc,%esp
80104d67:	68 4c 7a 10 80       	push   $0x80107a4c
...
80104da4:	e8 57 ea ff ff       	call   80103800 <myproc>
80104da9:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104dac:	8b 44 90 30          	mov    0x30(%eax,%edx,4),%eax
...
80104de9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104deb:	e8 10 ea ff ff       	call   80103800 <myproc>
...
80104e00:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
80104e04:	85 d2                	test   %edx,%edx
80104e06:	75 f0                	jne    80104df8 <sys_dup+0x28>
      curproc->ofile[fd] = f;
80104e08:	89 74 98 30          	mov    %esi,0x30(%eax,%ebx,4)
  filedup(f);
...
80104f33:	78 2b                	js     80104f60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104f35:	e8 c6 e8 ff ff       	call   80103800 <myproc>
80104f3a:	8b 55 f0             	mov    -0x10(%ebp),%edx
  fileclose(f);
80104f3d:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f40:	c7 44 90 30 00 00 00 	movl   $0x0,0x30(%eax,%edx,4)
80104f47:	00 
  fileclose(f);
...
801050cd:	e8 4e c8 ff ff       	call   80101920 <iunlockput>
  end_op();
801050d2:	e8 49 db ff ff       	call   80102c20 <end_op>
  return -1;
...
8010512f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105132:	e8 79 da ff ff       	call   80102bb0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80105159:	58                   	pop    %eax
8010515a:	5a                   	pop    %edx
8010515b:	68 68 7a 10 80       	push   $0x80107a68
...
80105174:	68 67 7a 10 80       	push   $0x80107a67
...
80105322:	0f 88 04 01 00 00    	js     8010542c <sys_open+0x13c>
  ...
  begin_op();
80105328:	e8 83 d8 ff ff       	call   80102bb0 <begin_op>
...
8010536f:	0f 84 a6 00 00 00    	je     8010541b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105375:	e8 86 e4 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105386:	0f 84 ac 00 00 00    	je     80105438 <sys_open+0x148>
    if(curproc->ofile[fd] == 0){
8010538c:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
...
80105394:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105397:	89 7c 98 30          	mov    %edi,0x30(%eax,%ebx,4)
  iunlock(ip);
...
801053fb:	0f 85 65 ff ff ff    	jne    80105366 <sys_open+0x76>
      end_op();
80105401:	e8 1a d8 ff ff       	call   80102c20 <end_op>
      return -1;
...
801054b3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801054b6:	e8 f5 d6 ff ff       	call   80102bb0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010551e:	e8 fd c3 ff ff       	call   80101920 <iunlockput>
  end_op();
80105523:	e8 f8 d6 ff ff       	call   80102c20 <end_op>
  return 0;
...
80105545:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105548:	e8 b3 e2 ff ff       	call   80103800 <myproc>
8010554d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010554f:	e8 5c d6 ff ff       	call   80102bb0 <begin_op>
...
801055c4:	e8 57 c3 ff ff       	call   80101920 <iunlockput>
    end_op();
801055c9:	e8 52 d6 ff ff       	call   80102c20 <end_op>
    return -1;
...
801055d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    end_op();
801055e0:	e8 3b d6 ff ff       	call   80102c20 <end_op>
    return -1;
...
8010570c:	e8 3f db ff ff       	call   80103250 <pipealloc>
...
8010571f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105721:	e8 da e0 ff ff       	call   80103800 <myproc>
...
80105736:	74 60                	je     80105798 <sys_pipe+0xb8>
    if(curproc->ofile[fd] == 0){
80105738:	8b 74 98 30          	mov    0x30(%eax,%ebx,4),%esi
8010573c:	85 f6                	test   %esi,%esi
8010573e:	75 f0                	jne    80105730 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80105740:	8d 73 0c             	lea    0xc(%ebx),%esi
80105743:	89 3c b0             	mov    %edi,(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105746:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105749:	e8 b2 e0 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010574e:	31 d2                	xor    %edx,%edx
80105750:	eb 0e                	jmp    80105760 <sys_pipe+0x80>
...
8010575e:	74 28                	je     80105788 <sys_pipe+0xa8>
    if(curproc->ofile[fd] == 0){
80105760:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
80105764:	85 c9                	test   %ecx,%ecx
80105766:	75 f0                	jne    80105758 <sys_pipe+0x78>
      curproc->ofile[fd] = f;
80105768:	89 7c 90 30          	mov    %edi,0x30(%eax,%edx,4)
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
8010578d:	c7 04 b0 00 00 00 00 	movl   $0x0,(%eax,%esi,4)
...
801057c3:	5d                   	pop    %ebp
	return fork();
801057c4:	e9 d7 e1 ff ff       	jmp    801039a0 <fork>
...
801057d3:	83 ec 08             	sub    $0x8,%esp
	exit();
801057d6:	e8 95 e5 ff ff       	call   80103d70 <exit>
...
801057e3:	5d                   	pop    %ebp
	return wait();
801057e4:	e9 57 e8 ff ff       	jmp    80104040 <wait>
...
8010580e:	e8 8d e9 ff ff       	call   801041a0 <kill>
...
80105833:	83 ec 08             	sub    $0x8,%esp
	return myproc()->pid;
80105836:	e8 c5 df ff ff       	call   80103800 <myproc>
8010583b:	8b 40 18             	mov    0x18(%eax),%eax
}
8010583e:	c9                   	leave  
8010583f:	c3                   	ret    
...
8010585e:	83 ec 0c             	sub    $0xc,%esp
	addr = myproc()->sz;
80105861:	8b 58 08             	mov    0x8(%eax),%ebx
	if(growproc(n) < 0)
80105864:	ff 75 f4             	pushl  -0xc(%ebp)
80105867:	e8 b4 e0 ff ff       	call   80103920 <growproc>
...
801058bd:	83 c4 10             	add    $0x10,%esp
	ticks0 = ticks;
801058c0:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
	while(ticks - ticks0 < n){
...
801058d8:	68 a0 56 11 80       	push   $0x801156a0
801058dd:	e8 9e e6 ff ff       	call   80103f80 <sleep>
	while(ticks - ticks0 < n){
801058e2:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
801058ef:	73 2f                	jae    80105920 <sys_sleep+0x90>
		if(myproc()->killed){
801058f1:	e8 0a df ff ff       	call   80103800 <myproc>
801058f6:	8b 40 2c             	mov    0x2c(%eax),%eax
801058f9:	85 c0                	test   %eax,%eax
801058fb:	74 d3                	je     801058d0 <sys_sleep+0x40>
			release(&tickslock);
801058fd:	83 ec 0c             	sub    $0xc,%esp
80105900:	68 60 4e 11 80       	push   $0x80114e60
...
80105923:	68 60 4e 11 80       	push   $0x80114e60
...
80105944:	83 ec 10             	sub    $0x10,%esp
	...
	acquire(&tickslock);
80105947:	68 60 4e 11 80       	push   $0x80114e60
8010594c:	e8 2f ed ff ff       	call   80104680 <acquire>
	xticks = ticks;
80105951:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
	release(&tickslock);
80105957:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
...
80105973:	5d                   	pop    %ebp
	return getnproc();
80105974:	e9 77 e9 ff ff       	jmp    801042f0 <getnproc>
80105979:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105980 <sys_getnice>:
...
80105996:	78 18                	js     801059b0 <sys_getnice+0x30>
		return -1;
	return getnval(pid);
80105998:	83 ec 0c             	sub    $0xc,%esp
8010599b:	ff 75 f4             	pushl  -0xc(%ebp)
8010599e:	e8 8d e9 ff ff       	call   80104330 <getnval>
...
801059f6:	e8 65 e9 ff ff       	call   80104360 <setnval>
...
80105a10:	55                   	push   %ebp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105a11:	b8 00 20 00 00       	mov    $0x2000,%eax
80105a16:	ba 04 06 00 00       	mov    $0x604,%edx
80105a1b:	89 e5                	mov    %esp,%ebp
80105a1d:	66 ef                	out    %ax,(%dx)
	char *p = "Shutdown";
80105a1f:	b9 ad 7a 10 80       	mov    $0x80107aad,%ecx
80105a24:	ba 04 b0 ff ff       	mov    $0xffffb004,%edx
80105a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105a30:	66 ef                	out    %ax,(%dx)


	outw( 0x604, 0x0 | 0x2000 );
	for( ; *p; p++)
80105a32:	83 c1 01             	add    $0x1,%ecx
80105a35:	80 39 00             	cmpb   $0x0,(%ecx)
80105a38:	75 f6                	jne    80105a30 <sys_halt+0x20>
		outw(0xB004, 0x2000);

	return 0;
}
80105a3a:	31 c0                	xor    %eax,%eax
80105a3c:	5d                   	pop    %ebp
80105a3d:	c3                   	ret    
...
80105a43:	5d                   	pop    %ebp
	psShow();
80105a44:	e9 57 e9 ff ff       	jmp    801043a0 <psShow>
...
80105a58:	54                   	push   %esp
  call trap
80105a59:	e8 c2 00 00 00       	call   80105b20 <trap>
  addl $4, %esp
...
80105a87:	c7 04 c5 a2 4e 11 80 	movl   $0x8e000008,-0x7feeb15e(,%eax,8)
80105a8e:	08 00 00 8e 
80105a92:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105a99:	80 
80105a9a:	c1 ea 10             	shr    $0x10,%edx
80105a9d:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
80105aa4:	80 
  for(i = 0; i < 256; i++)
...
80105ab4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ab7:	c7 05 a2 50 11 80 08 	movl   $0xef000008,0x801150a2
80105abe:	00 00 ef 
  initlock(&tickslock, "time");
80105ac1:	68 b6 7a 10 80       	push   $0x80107ab6
80105ac6:	68 60 4e 11 80       	push   $0x80114e60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105acb:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
80105ad1:	c1 e8 10             	shr    $0x10,%eax
80105ad4:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
80105ada:	e8 61 ea ff ff       	call   80104540 <initlock>
}
...
80105afb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105aff:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105b40:	ff 24 85 5c 7b 10 80 	jmp    *-0x7fef84a4(,%eax,4)
...
80105b50:	e8 ab dc ff ff       	call   80103800 <myproc>
...
80105b70:	e8 6b dc ff ff       	call   801037e0 <cpuid>
...
80105b81:	e8 7a dc ff ff       	call   80103800 <myproc>
80105b86:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105b89:	e8 72 dc ff ff       	call   80103800 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105b9d:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105b9e:	83 c2 74             	add    $0x74,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105ba1:	52                   	push   %edx
80105ba2:	ff 70 18             	pushl  0x18(%eax)
80105ba5:	68 18 7b 10 80       	push   $0x80107b18
...
80105bb7:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
  }
...
80105bbe:	e8 3d dc ff ff       	call   80103800 <myproc>
80105bc3:	85 c0                	test   %eax,%eax
80105bc5:	74 1d                	je     80105be4 <trap+0xc4>
80105bc7:	e8 34 dc ff ff       	call   80103800 <myproc>
80105bcc:	8b 50 2c             	mov    0x2c(%eax),%edx
...
80105be4:	e8 17 dc ff ff       	call   80103800 <myproc>
80105be9:	85 c0                	test   %eax,%eax
80105beb:	74 0b                	je     80105bf8 <trap+0xd8>
80105bed:	e8 0e dc ff ff       	call   80103800 <myproc>
80105bf2:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
80105bf6:	74 68                	je     80105c60 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bf8:	e8 03 dc ff ff       	call   80103800 <myproc>
80105bfd:	85 c0                	test   %eax,%eax
80105bff:	74 19                	je     80105c1a <trap+0xfa>
80105c01:	e8 fa db ff ff       	call   80103800 <myproc>
80105c06:	8b 40 2c             	mov    0x2c(%eax),%eax
...
80105c22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(myproc()->killed)
80105c28:	e8 d3 db ff ff       	call   80103800 <myproc>
80105c2d:	8b 58 2c             	mov    0x2c(%eax),%ebx
80105c30:	85 db                	test   %ebx,%ebx
80105c32:	0f 85 e8 00 00 00    	jne    80105d20 <trap+0x200>
    myproc()->tf = tf;
80105c38:	e8 c3 db ff ff       	call   80103800 <myproc>
80105c3d:	89 78 20             	mov    %edi,0x20(%eax)
    syscall();
80105c40:	e8 3b ef ff ff       	call   80104b80 <syscall>
    if(myproc()->killed)
80105c45:	e8 b6 db ff ff       	call   80103800 <myproc>
80105c4a:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
80105c94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c98:	e8 83 c9 ff ff       	call   80102620 <kbdintr>
    lapiceoi();
...
80105cdf:	e8 fc da ff ff       	call   801037e0 <cpuid>
80105ce4:	56                   	push   %esi
80105ce5:	53                   	push   %ebx
80105ce6:	50                   	push   %eax
80105ce7:	68 c0 7a 10 80       	push   $0x80107ac0
80105cec:	e8 6f a9 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105cf1:	e8 6a ca ff ff       	call   80102760 <lapiceoi>
    break;
80105cf6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cf9:	e8 02 db ff ff       	call   80103800 <myproc>
...
80105d1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d20:	e8 4b e0 ff ff       	call   80103d70 <exit>
80105d25:	e9 0e ff ff ff       	jmp    80105c38 <trap+0x118>
80105d2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105d30:	e8 3b e0 ff ff       	call   80103d70 <exit>
80105d35:	e9 aa fe ff ff       	jmp    80105be4 <trap+0xc4>
80105d3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105d40:	83 ec 0c             	sub    $0xc,%esp
80105d43:	68 60 4e 11 80       	push   $0x80114e60
80105d48:	e8 33 e9 ff ff       	call   80104680 <acquire>
      wakeup(&ticks);
80105d4d:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105d54:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105d5b:	e8 e0 e3 ff ff       	call   80104140 <wakeup>
      release(&tickslock);
80105d60:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105d67:	e8 d4 e9 ff ff       	call   80104740 <release>
80105d6c:	83 c4 10             	add    $0x10,%esp
80105d6f:	e9 09 ff ff ff       	jmp    80105c7d <trap+0x15d>
80105d74:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d77:	e8 64 da ff ff       	call   801037e0 <cpuid>
...
80105d85:	68 e4 7a 10 80       	push   $0x80107ae4
80105d8a:	e8 d1 a8 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105d8f:	83 c4 14             	add    $0x14,%esp
80105d92:	68 bb 7a 10 80       	push   $0x80107abb
...
80105df5:	e8 86 c9 ff ff       	call   80102780 <microdelay>
...
80105e8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105e8f:	bb dc 7b 10 80       	mov    $0x80107bdc,%ebx
  ioapicenable(IRQ_COM1, 0);
80105e94:	6a 00                	push   $0x0
80105e96:	6a 04                	push   $0x4
80105e98:	e8 43 c4 ff ff       	call   801022e0 <ioapicenable>
...
80105f27:	6a 00                	push   $0x0
  jmp alltraps
80105f29:	e9 1b fb ff ff       	jmp    80105a49 <alltraps>
...
80105f30:	6a 01                	push   $0x1
  jmp alltraps
80105f32:	e9 12 fb ff ff       	jmp    80105a49 <alltraps>
...
80105f39:	6a 02                	push   $0x2
  jmp alltraps
80105f3b:	e9 09 fb ff ff       	jmp    80105a49 <alltraps>
...
80105f42:	6a 03                	push   $0x3
  jmp alltraps
80105f44:	e9 00 fb ff ff       	jmp    80105a49 <alltraps>
...
80105f4b:	6a 04                	push   $0x4
  jmp alltraps
80105f4d:	e9 f7 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f54:	6a 05                	push   $0x5
  jmp alltraps
80105f56:	e9 ee fa ff ff       	jmp    80105a49 <alltraps>
...
80105f5d:	6a 06                	push   $0x6
  jmp alltraps
80105f5f:	e9 e5 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f66:	6a 07                	push   $0x7
  jmp alltraps
80105f68:	e9 dc fa ff ff       	jmp    80105a49 <alltraps>
...
80105f6d:	6a 08                	push   $0x8
  jmp alltraps
80105f6f:	e9 d5 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f76:	6a 09                	push   $0x9
  jmp alltraps
80105f78:	e9 cc fa ff ff       	jmp    80105a49 <alltraps>
...
80105f7d:	6a 0a                	push   $0xa
  jmp alltraps
80105f7f:	e9 c5 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f84:	6a 0b                	push   $0xb
  jmp alltraps
80105f86:	e9 be fa ff ff       	jmp    80105a49 <alltraps>
...
80105f8b:	6a 0c                	push   $0xc
  jmp alltraps
80105f8d:	e9 b7 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f92:	6a 0d                	push   $0xd
  jmp alltraps
80105f94:	e9 b0 fa ff ff       	jmp    80105a49 <alltraps>
...
80105f99:	6a 0e                	push   $0xe
  jmp alltraps
80105f9b:	e9 a9 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fa2:	6a 0f                	push   $0xf
  jmp alltraps
80105fa4:	e9 a0 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fab:	6a 10                	push   $0x10
  jmp alltraps
80105fad:	e9 97 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fb2:	6a 11                	push   $0x11
  jmp alltraps
80105fb4:	e9 90 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fbb:	6a 12                	push   $0x12
  jmp alltraps
80105fbd:	e9 87 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fc4:	6a 13                	push   $0x13
  jmp alltraps
80105fc6:	e9 7e fa ff ff       	jmp    80105a49 <alltraps>
...
80105fcd:	6a 14                	push   $0x14
  jmp alltraps
80105fcf:	e9 75 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fd6:	6a 15                	push   $0x15
  jmp alltraps
80105fd8:	e9 6c fa ff ff       	jmp    80105a49 <alltraps>
...
80105fdf:	6a 16                	push   $0x16
  jmp alltraps
80105fe1:	e9 63 fa ff ff       	jmp    80105a49 <alltraps>
...
80105fe8:	6a 17                	push   $0x17
  jmp alltraps
80105fea:	e9 5a fa ff ff       	jmp    80105a49 <alltraps>
...
80105ff1:	6a 18                	push   $0x18
  jmp alltraps
80105ff3:	e9 51 fa ff ff       	jmp    80105a49 <alltraps>
...
80105ffa:	6a 19                	push   $0x19
  jmp alltraps
80105ffc:	e9 48 fa ff ff       	jmp    80105a49 <alltraps>
...
80106003:	6a 1a                	push   $0x1a
  jmp alltraps
80106005:	e9 3f fa ff ff       	jmp    80105a49 <alltraps>
...
8010600c:	6a 1b                	push   $0x1b
  jmp alltraps
8010600e:	e9 36 fa ff ff       	jmp    80105a49 <alltraps>
...
80106015:	6a 1c                	push   $0x1c
  jmp alltraps
80106017:	e9 2d fa ff ff       	jmp    80105a49 <alltraps>
...
8010601e:	6a 1d                	push   $0x1d
  jmp alltraps
80106020:	e9 24 fa ff ff       	jmp    80105a49 <alltraps>
...
80106027:	6a 1e                	push   $0x1e
  jmp alltraps
80106029:	e9 1b fa ff ff       	jmp    80105a49 <alltraps>
...
80106030:	6a 1f                	push   $0x1f
  jmp alltraps
80106032:	e9 12 fa ff ff       	jmp    80105a49 <alltraps>
...
80106039:	6a 20                	push   $0x20
  jmp alltraps
8010603b:	e9 09 fa ff ff       	jmp    80105a49 <alltraps>
...
80106042:	6a 21                	push   $0x21
  jmp alltraps
80106044:	e9 00 fa ff ff       	jmp    80105a49 <alltraps>
...
8010604b:	6a 22                	push   $0x22
  jmp alltraps
8010604d:	e9 f7 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106054:	6a 23                	push   $0x23
  jmp alltraps
80106056:	e9 ee f9 ff ff       	jmp    80105a49 <alltraps>
...
8010605d:	6a 24                	push   $0x24
  jmp alltraps
8010605f:	e9 e5 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106066:	6a 25                	push   $0x25
  jmp alltraps
80106068:	e9 dc f9 ff ff       	jmp    80105a49 <alltraps>
...
8010606f:	6a 26                	push   $0x26
  jmp alltraps
80106071:	e9 d3 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106078:	6a 27                	push   $0x27
  jmp alltraps
8010607a:	e9 ca f9 ff ff       	jmp    80105a49 <alltraps>
...
80106081:	6a 28                	push   $0x28
  jmp alltraps
80106083:	e9 c1 f9 ff ff       	jmp    80105a49 <alltraps>
...
8010608a:	6a 29                	push   $0x29
  jmp alltraps
8010608c:	e9 b8 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106093:	6a 2a                	push   $0x2a
  jmp alltraps
80106095:	e9 af f9 ff ff       	jmp    80105a49 <alltraps>
...
8010609c:	6a 2b                	push   $0x2b
  jmp alltraps
8010609e:	e9 a6 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060a5:	6a 2c                	push   $0x2c
  jmp alltraps
801060a7:	e9 9d f9 ff ff       	jmp    80105a49 <alltraps>
...
801060ae:	6a 2d                	push   $0x2d
  jmp alltraps
801060b0:	e9 94 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060b7:	6a 2e                	push   $0x2e
  jmp alltraps
801060b9:	e9 8b f9 ff ff       	jmp    80105a49 <alltraps>
...
801060c0:	6a 2f                	push   $0x2f
  jmp alltraps
801060c2:	e9 82 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060c9:	6a 30                	push   $0x30
  jmp alltraps
801060cb:	e9 79 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060d2:	6a 31                	push   $0x31
  jmp alltraps
801060d4:	e9 70 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060db:	6a 32                	push   $0x32
  jmp alltraps
801060dd:	e9 67 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060e4:	6a 33                	push   $0x33
  jmp alltraps
801060e6:	e9 5e f9 ff ff       	jmp    80105a49 <alltraps>
...
801060ed:	6a 34                	push   $0x34
  jmp alltraps
801060ef:	e9 55 f9 ff ff       	jmp    80105a49 <alltraps>
...
801060f6:	6a 35                	push   $0x35
  jmp alltraps
801060f8:	e9 4c f9 ff ff       	jmp    80105a49 <alltraps>
...
801060ff:	6a 36                	push   $0x36
  jmp alltraps
80106101:	e9 43 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106108:	6a 37                	push   $0x37
  jmp alltraps
8010610a:	e9 3a f9 ff ff       	jmp    80105a49 <alltraps>
...
80106111:	6a 38                	push   $0x38
  jmp alltraps
80106113:	e9 31 f9 ff ff       	jmp    80105a49 <alltraps>
...
8010611a:	6a 39                	push   $0x39
  jmp alltraps
8010611c:	e9 28 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106123:	6a 3a                	push   $0x3a
  jmp alltraps
80106125:	e9 1f f9 ff ff       	jmp    80105a49 <alltraps>
...
8010612c:	6a 3b                	push   $0x3b
  jmp alltraps
8010612e:	e9 16 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106135:	6a 3c                	push   $0x3c
  jmp alltraps
80106137:	e9 0d f9 ff ff       	jmp    80105a49 <alltraps>
...
8010613e:	6a 3d                	push   $0x3d
  jmp alltraps
80106140:	e9 04 f9 ff ff       	jmp    80105a49 <alltraps>
...
80106147:	6a 3e                	push   $0x3e
  jmp alltraps
80106149:	e9 fb f8 ff ff       	jmp    80105a49 <alltraps>
...
80106150:	6a 3f                	push   $0x3f
  jmp alltraps
80106152:	e9 f2 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106159:	6a 40                	push   $0x40
  jmp alltraps
8010615b:	e9 e9 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106162:	6a 41                	push   $0x41
  jmp alltraps
80106164:	e9 e0 f8 ff ff       	jmp    80105a49 <alltraps>
...
8010616b:	6a 42                	push   $0x42
  jmp alltraps
8010616d:	e9 d7 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106174:	6a 43                	push   $0x43
  jmp alltraps
80106176:	e9 ce f8 ff ff       	jmp    80105a49 <alltraps>
...
8010617d:	6a 44                	push   $0x44
  jmp alltraps
8010617f:	e9 c5 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106186:	6a 45                	push   $0x45
  jmp alltraps
80106188:	e9 bc f8 ff ff       	jmp    80105a49 <alltraps>
...
8010618f:	6a 46                	push   $0x46
  jmp alltraps
80106191:	e9 b3 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106198:	6a 47                	push   $0x47
  jmp alltraps
8010619a:	e9 aa f8 ff ff       	jmp    80105a49 <alltraps>
...
801061a1:	6a 48                	push   $0x48
  jmp alltraps
801061a3:	e9 a1 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061aa:	6a 49                	push   $0x49
  jmp alltraps
801061ac:	e9 98 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061b3:	6a 4a                	push   $0x4a
  jmp alltraps
801061b5:	e9 8f f8 ff ff       	jmp    80105a49 <alltraps>
...
801061bc:	6a 4b                	push   $0x4b
  jmp alltraps
801061be:	e9 86 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061c5:	6a 4c                	push   $0x4c
  jmp alltraps
801061c7:	e9 7d f8 ff ff       	jmp    80105a49 <alltraps>
...
801061ce:	6a 4d                	push   $0x4d
  jmp alltraps
801061d0:	e9 74 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061d7:	6a 4e                	push   $0x4e
  jmp alltraps
801061d9:	e9 6b f8 ff ff       	jmp    80105a49 <alltraps>
...
801061e0:	6a 4f                	push   $0x4f
  jmp alltraps
801061e2:	e9 62 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061e9:	6a 50                	push   $0x50
  jmp alltraps
801061eb:	e9 59 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061f2:	6a 51                	push   $0x51
  jmp alltraps
801061f4:	e9 50 f8 ff ff       	jmp    80105a49 <alltraps>
...
801061fb:	6a 52                	push   $0x52
  jmp alltraps
801061fd:	e9 47 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106204:	6a 53                	push   $0x53
  jmp alltraps
80106206:	e9 3e f8 ff ff       	jmp    80105a49 <alltraps>
...
8010620d:	6a 54                	push   $0x54
  jmp alltraps
8010620f:	e9 35 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106216:	6a 55                	push   $0x55
  jmp alltraps
80106218:	e9 2c f8 ff ff       	jmp    80105a49 <alltraps>
...
8010621f:	6a 56                	push   $0x56
  jmp alltraps
80106221:	e9 23 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106228:	6a 57                	push   $0x57
  jmp alltraps
8010622a:	e9 1a f8 ff ff       	jmp    80105a49 <alltraps>
...
80106231:	6a 58                	push   $0x58
  jmp alltraps
80106233:	e9 11 f8 ff ff       	jmp    80105a49 <alltraps>
...
8010623a:	6a 59                	push   $0x59
  jmp alltraps
8010623c:	e9 08 f8 ff ff       	jmp    80105a49 <alltraps>
...
80106243:	6a 5a                	push   $0x5a
  jmp alltraps
80106245:	e9 ff f7 ff ff       	jmp    80105a49 <alltraps>
...
8010624c:	6a 5b                	push   $0x5b
  jmp alltraps
8010624e:	e9 f6 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106255:	6a 5c                	push   $0x5c
  jmp alltraps
80106257:	e9 ed f7 ff ff       	jmp    80105a49 <alltraps>
...
8010625e:	6a 5d                	push   $0x5d
  jmp alltraps
80106260:	e9 e4 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106267:	6a 5e                	push   $0x5e
  jmp alltraps
80106269:	e9 db f7 ff ff       	jmp    80105a49 <alltraps>
...
80106270:	6a 5f                	push   $0x5f
  jmp alltraps
80106272:	e9 d2 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106279:	6a 60                	push   $0x60
  jmp alltraps
8010627b:	e9 c9 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106282:	6a 61                	push   $0x61
  jmp alltraps
80106284:	e9 c0 f7 ff ff       	jmp    80105a49 <alltraps>
...
8010628b:	6a 62                	push   $0x62
  jmp alltraps
8010628d:	e9 b7 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106294:	6a 63                	push   $0x63
  jmp alltraps
80106296:	e9 ae f7 ff ff       	jmp    80105a49 <alltraps>
...
8010629d:	6a 64                	push   $0x64
  jmp alltraps
8010629f:	e9 a5 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062a6:	6a 65                	push   $0x65
  jmp alltraps
801062a8:	e9 9c f7 ff ff       	jmp    80105a49 <alltraps>
...
801062af:	6a 66                	push   $0x66
  jmp alltraps
801062b1:	e9 93 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062b8:	6a 67                	push   $0x67
  jmp alltraps
801062ba:	e9 8a f7 ff ff       	jmp    80105a49 <alltraps>
...
801062c1:	6a 68                	push   $0x68
  jmp alltraps
801062c3:	e9 81 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062ca:	6a 69                	push   $0x69
  jmp alltraps
801062cc:	e9 78 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062d3:	6a 6a                	push   $0x6a
  jmp alltraps
801062d5:	e9 6f f7 ff ff       	jmp    80105a49 <alltraps>
...
801062dc:	6a 6b                	push   $0x6b
  jmp alltraps
801062de:	e9 66 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062e5:	6a 6c                	push   $0x6c
  jmp alltraps
801062e7:	e9 5d f7 ff ff       	jmp    80105a49 <alltraps>
...
801062ee:	6a 6d                	push   $0x6d
  jmp alltraps
801062f0:	e9 54 f7 ff ff       	jmp    80105a49 <alltraps>
...
801062f7:	6a 6e                	push   $0x6e
  jmp alltraps
801062f9:	e9 4b f7 ff ff       	jmp    80105a49 <alltraps>
...
80106300:	6a 6f                	push   $0x6f
  jmp alltraps
80106302:	e9 42 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106309:	6a 70                	push   $0x70
  jmp alltraps
8010630b:	e9 39 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106312:	6a 71                	push   $0x71
  jmp alltraps
80106314:	e9 30 f7 ff ff       	jmp    80105a49 <alltraps>
...
8010631b:	6a 72                	push   $0x72
  jmp alltraps
8010631d:	e9 27 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106324:	6a 73                	push   $0x73
  jmp alltraps
80106326:	e9 1e f7 ff ff       	jmp    80105a49 <alltraps>
...
8010632d:	6a 74                	push   $0x74
  jmp alltraps
8010632f:	e9 15 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106336:	6a 75                	push   $0x75
  jmp alltraps
80106338:	e9 0c f7 ff ff       	jmp    80105a49 <alltraps>
...
8010633f:	6a 76                	push   $0x76
  jmp alltraps
80106341:	e9 03 f7 ff ff       	jmp    80105a49 <alltraps>
...
80106348:	6a 77                	push   $0x77
  jmp alltraps
8010634a:	e9 fa f6 ff ff       	jmp    80105a49 <alltraps>
...
80106351:	6a 78                	push   $0x78
  jmp alltraps
80106353:	e9 f1 f6 ff ff       	jmp    80105a49 <alltraps>
...
8010635a:	6a 79                	push   $0x79
  jmp alltraps
8010635c:	e9 e8 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106363:	6a 7a                	push   $0x7a
  jmp alltraps
80106365:	e9 df f6 ff ff       	jmp    80105a49 <alltraps>
...
8010636c:	6a 7b                	push   $0x7b
  jmp alltraps
8010636e:	e9 d6 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106375:	6a 7c                	push   $0x7c
  jmp alltraps
80106377:	e9 cd f6 ff ff       	jmp    80105a49 <alltraps>
...
8010637e:	6a 7d                	push   $0x7d
  jmp alltraps
80106380:	e9 c4 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106387:	6a 7e                	push   $0x7e
  jmp alltraps
80106389:	e9 bb f6 ff ff       	jmp    80105a49 <alltraps>
...
80106390:	6a 7f                	push   $0x7f
  jmp alltraps
80106392:	e9 b2 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106399:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010639e:	e9 a6 f6 ff ff       	jmp    80105a49 <alltraps>
...
801063a5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801063aa:	e9 9a f6 ff ff       	jmp    80105a49 <alltraps>
...
801063b1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801063b6:	e9 8e f6 ff ff       	jmp    80105a49 <alltraps>
...
801063bd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801063c2:	e9 82 f6 ff ff       	jmp    80105a49 <alltraps>
...
801063c9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801063ce:	e9 76 f6 ff ff       	jmp    80105a49 <alltraps>
...
801063d5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801063da:	e9 6a f6 ff ff       	jmp    80105a49 <alltraps>
...
801063e1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801063e6:	e9 5e f6 ff ff       	jmp    80105a49 <alltraps>
...
801063ed:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801063f2:	e9 52 f6 ff ff       	jmp    80105a49 <alltraps>
...
801063f9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801063fe:	e9 46 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106405:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010640a:	e9 3a f6 ff ff       	jmp    80105a49 <alltraps>
...
80106411:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106416:	e9 2e f6 ff ff       	jmp    80105a49 <alltraps>
...
8010641d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106422:	e9 22 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106429:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010642e:	e9 16 f6 ff ff       	jmp    80105a49 <alltraps>
...
80106435:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010643a:	e9 0a f6 ff ff       	jmp    80105a49 <alltraps>
...
80106441:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106446:	e9 fe f5 ff ff       	jmp    80105a49 <alltraps>
...
8010644d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106452:	e9 f2 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106459:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010645e:	e9 e6 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106465:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010646a:	e9 da f5 ff ff       	jmp    80105a49 <alltraps>
...
80106471:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106476:	e9 ce f5 ff ff       	jmp    80105a49 <alltraps>
...
8010647d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106482:	e9 c2 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106489:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010648e:	e9 b6 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106495:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010649a:	e9 aa f5 ff ff       	jmp    80105a49 <alltraps>
...
801064a1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801064a6:	e9 9e f5 ff ff       	jmp    80105a49 <alltraps>
...
801064ad:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801064b2:	e9 92 f5 ff ff       	jmp    80105a49 <alltraps>
...
801064b9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801064be:	e9 86 f5 ff ff       	jmp    80105a49 <alltraps>
...
801064c5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801064ca:	e9 7a f5 ff ff       	jmp    80105a49 <alltraps>
...
801064d1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801064d6:	e9 6e f5 ff ff       	jmp    80105a49 <alltraps>
...
801064dd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801064e2:	e9 62 f5 ff ff       	jmp    80105a49 <alltraps>
...
801064e9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801064ee:	e9 56 f5 ff ff       	jmp    80105a49 <alltraps>
...
801064f5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801064fa:	e9 4a f5 ff ff       	jmp    80105a49 <alltraps>
...
80106501:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106506:	e9 3e f5 ff ff       	jmp    80105a49 <alltraps>
...
8010650d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106512:	e9 32 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106519:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010651e:	e9 26 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106525:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010652a:	e9 1a f5 ff ff       	jmp    80105a49 <alltraps>
...
80106531:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106536:	e9 0e f5 ff ff       	jmp    80105a49 <alltraps>
...
8010653d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106542:	e9 02 f5 ff ff       	jmp    80105a49 <alltraps>
...
80106549:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010654e:	e9 f6 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106555:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010655a:	e9 ea f4 ff ff       	jmp    80105a49 <alltraps>
...
80106561:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106566:	e9 de f4 ff ff       	jmp    80105a49 <alltraps>
...
8010656d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106572:	e9 d2 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106579:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010657e:	e9 c6 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106585:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010658a:	e9 ba f4 ff ff       	jmp    80105a49 <alltraps>
...
80106591:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106596:	e9 ae f4 ff ff       	jmp    80105a49 <alltraps>
...
8010659d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801065a2:	e9 a2 f4 ff ff       	jmp    80105a49 <alltraps>
...
801065a9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801065ae:	e9 96 f4 ff ff       	jmp    80105a49 <alltraps>
...
801065b5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801065ba:	e9 8a f4 ff ff       	jmp    80105a49 <alltraps>
...
801065c1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801065c6:	e9 7e f4 ff ff       	jmp    80105a49 <alltraps>
...
801065cd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801065d2:	e9 72 f4 ff ff       	jmp    80105a49 <alltraps>
...
801065d9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801065de:	e9 66 f4 ff ff       	jmp    80105a49 <alltraps>
...
801065e5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801065ea:	e9 5a f4 ff ff       	jmp    80105a49 <alltraps>
...
801065f1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801065f6:	e9 4e f4 ff ff       	jmp    80105a49 <alltraps>
...
801065fd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106602:	e9 42 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106609:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010660e:	e9 36 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106615:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010661a:	e9 2a f4 ff ff       	jmp    80105a49 <alltraps>
...
80106621:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106626:	e9 1e f4 ff ff       	jmp    80105a49 <alltraps>
...
8010662d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106632:	e9 12 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106639:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010663e:	e9 06 f4 ff ff       	jmp    80105a49 <alltraps>
...
80106645:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010664a:	e9 fa f3 ff ff       	jmp    80105a49 <alltraps>
...
80106651:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106656:	e9 ee f3 ff ff       	jmp    80105a49 <alltraps>
...
8010665d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106662:	e9 e2 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106669:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010666e:	e9 d6 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106675:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010667a:	e9 ca f3 ff ff       	jmp    80105a49 <alltraps>
...
80106681:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106686:	e9 be f3 ff ff       	jmp    80105a49 <alltraps>
...
8010668d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106692:	e9 b2 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106699:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010669e:	e9 a6 f3 ff ff       	jmp    80105a49 <alltraps>
...
801066a5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801066aa:	e9 9a f3 ff ff       	jmp    80105a49 <alltraps>
...
801066b1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801066b6:	e9 8e f3 ff ff       	jmp    80105a49 <alltraps>
...
801066bd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801066c2:	e9 82 f3 ff ff       	jmp    80105a49 <alltraps>
...
801066c9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801066ce:	e9 76 f3 ff ff       	jmp    80105a49 <alltraps>
...
801066d5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801066da:	e9 6a f3 ff ff       	jmp    80105a49 <alltraps>
...
801066e1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801066e6:	e9 5e f3 ff ff       	jmp    80105a49 <alltraps>
...
801066ed:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801066f2:	e9 52 f3 ff ff       	jmp    80105a49 <alltraps>
...
801066f9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801066fe:	e9 46 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106705:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010670a:	e9 3a f3 ff ff       	jmp    80105a49 <alltraps>
...
80106711:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106716:	e9 2e f3 ff ff       	jmp    80105a49 <alltraps>
...
8010671d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106722:	e9 22 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106729:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010672e:	e9 16 f3 ff ff       	jmp    80105a49 <alltraps>
...
80106735:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010673a:	e9 0a f3 ff ff       	jmp    80105a49 <alltraps>
...
80106741:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106746:	e9 fe f2 ff ff       	jmp    80105a49 <alltraps>
...
8010674d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106752:	e9 f2 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106759:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010675e:	e9 e6 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106765:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010676a:	e9 da f2 ff ff       	jmp    80105a49 <alltraps>
...
80106771:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106776:	e9 ce f2 ff ff       	jmp    80105a49 <alltraps>
...
8010677d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106782:	e9 c2 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106789:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010678e:	e9 b6 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106795:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010679a:	e9 aa f2 ff ff       	jmp    80105a49 <alltraps>
...
801067a1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801067a6:	e9 9e f2 ff ff       	jmp    80105a49 <alltraps>
...
801067ad:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801067b2:	e9 92 f2 ff ff       	jmp    80105a49 <alltraps>
...
801067b9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801067be:	e9 86 f2 ff ff       	jmp    80105a49 <alltraps>
...
801067c5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801067ca:	e9 7a f2 ff ff       	jmp    80105a49 <alltraps>
...
801067d1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801067d6:	e9 6e f2 ff ff       	jmp    80105a49 <alltraps>
...
801067dd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801067e2:	e9 62 f2 ff ff       	jmp    80105a49 <alltraps>
...
801067e9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801067ee:	e9 56 f2 ff ff       	jmp    80105a49 <alltraps>
...
801067f5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801067fa:	e9 4a f2 ff ff       	jmp    80105a49 <alltraps>
...
80106801:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106806:	e9 3e f2 ff ff       	jmp    80105a49 <alltraps>
...
8010680d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106812:	e9 32 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106819:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010681e:	e9 26 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106825:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010682a:	e9 1a f2 ff ff       	jmp    80105a49 <alltraps>
...
80106831:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106836:	e9 0e f2 ff ff       	jmp    80105a49 <alltraps>
...
8010683d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106842:	e9 02 f2 ff ff       	jmp    80105a49 <alltraps>
...
80106849:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010684e:	e9 f6 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106855:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010685a:	e9 ea f1 ff ff       	jmp    80105a49 <alltraps>
...
80106861:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106866:	e9 de f1 ff ff       	jmp    80105a49 <alltraps>
...
8010686d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106872:	e9 d2 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106879:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010687e:	e9 c6 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106885:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010688a:	e9 ba f1 ff ff       	jmp    80105a49 <alltraps>
...
80106891:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106896:	e9 ae f1 ff ff       	jmp    80105a49 <alltraps>
...
8010689d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801068a2:	e9 a2 f1 ff ff       	jmp    80105a49 <alltraps>
...
801068a9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801068ae:	e9 96 f1 ff ff       	jmp    80105a49 <alltraps>
...
801068b5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801068ba:	e9 8a f1 ff ff       	jmp    80105a49 <alltraps>
...
801068c1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801068c6:	e9 7e f1 ff ff       	jmp    80105a49 <alltraps>
...
801068cd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801068d2:	e9 72 f1 ff ff       	jmp    80105a49 <alltraps>
...
801068d9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801068de:	e9 66 f1 ff ff       	jmp    80105a49 <alltraps>
...
801068e5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801068ea:	e9 5a f1 ff ff       	jmp    80105a49 <alltraps>
...
801068f1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801068f6:	e9 4e f1 ff ff       	jmp    80105a49 <alltraps>
...
801068fd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106902:	e9 42 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106909:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010690e:	e9 36 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106915:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010691a:	e9 2a f1 ff ff       	jmp    80105a49 <alltraps>
...
80106921:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106926:	e9 1e f1 ff ff       	jmp    80105a49 <alltraps>
...
8010692d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106932:	e9 12 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106939:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010693e:	e9 06 f1 ff ff       	jmp    80105a49 <alltraps>
...
80106945:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010694a:	e9 fa f0 ff ff       	jmp    80105a49 <alltraps>
...
80106951:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106956:	e9 ee f0 ff ff       	jmp    80105a49 <alltraps>
...
8010695d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106962:	e9 e2 f0 ff ff       	jmp    80105a49 <alltraps>
...
80106969:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010696e:	e9 d6 f0 ff ff       	jmp    80105a49 <alltraps>
...
80106975:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010697a:	e9 ca f0 ff ff       	jmp    80105a49 <alltraps>
...
80106981:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106986:	e9 be f0 ff ff       	jmp    80105a49 <alltraps>
...
8010698d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106992:	e9 b2 f0 ff ff       	jmp    80105a49 <alltraps>
...
801069e4:	e8 e7 ba ff ff       	call   801024d0 <kalloc>
...
801069fa:	e8 91 dd ff ff       	call   80104790 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106a9d:	68 e4 7b 10 80       	push   $0x80107be4
...
80106af4:	e8 27 b8 ff ff       	call   80102320 <kfree>
      *pte = 0;
...
80106b53:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b56:	e8 85 cc ff ff       	call   801037e0 <cpuid>
...
80106be0:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106c2f:	e8 2c cb ff ff       	call   80103760 <mycpu>
80106c34:	89 c6                	mov    %eax,%esi
80106c36:	e8 25 cb ff ff       	call   80103760 <mycpu>
80106c3b:	89 c7                	mov    %eax,%edi
80106c3d:	e8 1e cb ff ff       	call   80103760 <mycpu>
80106c42:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c45:	83 c7 08             	add    $0x8,%edi
80106c48:	e8 13 cb ff ff       	call   80103760 <mycpu>
...
80106d2b:	77 49                	ja     80106d76 <inituvm+0x66>
  mem = kalloc();
80106d2d:	e8 9e b7 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106d3f:	e8 4c da ff ff       	call   80104790 <memset>
...
80106d70:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d71:	e9 ca da ff ff       	jmp    80104840 <memmove>
    panic("inituvm: more than a page");
80106d76:	83 ec 0c             	sub    $0xc,%esp
80106d79:	68 29 7c 10 80       	push   $0x80107c29
...
80106e01:	e8 6a ab ff ff       	call   80101970 <readi>
...
80106ec9:	0f 86 81 00 00 00    	jbe    80106f50 <allocuvm+0x100>
    mem = kalloc();
80106ecf:	e8 fc b5 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
...
80106edd:	68 61 7c 10 80       	push   $0x80107c61
...
80106f13:	68 79 7c 10 80       	push   $0x80107c79
...
80106f3b:	e8 e0 b3 ff ff       	call   80102320 <kfree>
      return 0;
...
80106ffe:	e8 1d b3 ff ff       	call   80102320 <kfree>
...
80107013:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107014:	e9 07 b3 ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80107019:	83 ec 0c             	sub    $0xc,%esp
8010701c:	68 95 7c 10 80       	push   $0x80107c95
...
80107035:	e8 96 b4 ff ff       	call   801024d0 <kalloc>
...
80107050:	e8 3b d7 ff ff       	call   80104790 <memset>
...
801070ef:	68 a6 7c 10 80       	push   $0x80107ca6
...
80107195:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107198:	e8 33 b3 ff ff       	call   801024d0 <kalloc>
