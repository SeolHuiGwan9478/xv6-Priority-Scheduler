...
main(void)
{
  ...
  19:	e8 84 03 00 00       	call   3a2 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 a7 03 00 00       	call   3da <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 9b 03 00 00       	call   3da <dup>
  ...
  cb:	68 7d 08 00 00       	push   $0x87d
  d0:	e8 c5 02 00 00       	call   39a <exec>
      printf(1, "init: exec sh failed\n");
  d5:	5a                   	pop    %edx
  d6:	59                   	pop    %ecx
  d7:	68 80 08 00 00       	push   $0x880
  dc:	6a 01                	push   $0x1
  ...
  f2:	e8 b3 02 00 00       	call   3aa <mknod>
    open("console", O_RDWR);
  f7:	5b                   	pop    %ebx
  f8:	58                   	pop    %eax
  f9:	6a 02                	push   $0x2
  fb:	68 28 08 00 00       	push   $0x828
 100:	e8 9d 02 00 00       	call   3a2 <open>
