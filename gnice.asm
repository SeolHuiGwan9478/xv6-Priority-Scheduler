...
int main(int argc, char* argv[]){
  ...
  20:	e8 3b 04 00 00       	call   460 <printf>
		exit();
  25:	e8 c8 02 00 00       	call   2f2 <exit>
	}

	pid = myatoi(argv[1]);
  2a:	83 ec 0c             	sub    $0xc,%esp
  2d:	ff 70 04             	pushl  0x4(%eax)
  30:	e8 3b 00 00 00       	call   70 <myatoi>
  ...
  38:	89 c3                	mov    %eax,%ebx
	if((val = getnice(pid)) != -1)
  3a:	e8 5b 03 00 00       	call   39a <getnice>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	83 f8 ff             	cmp    $0xffffffff,%eax
  45:	74 16                	je     5d <main+0x5d>
		printf(1, "Nice of PID <%d> is %d.\n", pid, val);
  47:	50                   	push   %eax
  48:	53                   	push   %ebx
  49:	68 cc 07 00 00       	push   $0x7cc
  4e:	6a 01                	push   $0x1
  ...
  5d:	50                   	push   %eax
  5e:	53                   	push   %ebx
  5f:	68 e5 07 00 00       	push   $0x7e5
  64:	6a 02                	push   $0x2
  66:	e8 f5 03 00 00       	call   460 <printf>
  6b:	83 c4 10             	add    $0x10,%esp
  6e:	eb e8                	jmp    58 <main+0x58>
...
00000070 <myatoi>:
{
  ...
  76:	8b 45 08             	mov    0x8(%ebp),%eax
	if (str[0]=='-') {
  79:	80 38 2d             	cmpb   $0x2d,(%eax)
  7c:	74 0a                	je     88 <myatoi+0x18>
}
  7e:	c9                   	leave  
	else return atoi(str);
  7f:	e9 fc 01 00 00       	jmp    280 <atoi>
  84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		return -1*atoi(&str[1]);
  88:	83 ec 0c             	sub    $0xc,%esp
  8b:	83 c0 01             	add    $0x1,%eax
  8e:	50                   	push   %eax
  8f:	e8 ec 01 00 00       	call   280 <atoi>
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb 01 08 00 00       	mov    $0x801,%ebx
        while(*s != 0){
 ...
 631:	a1 d8 0a 00 00       	mov    0xad8,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
    ...
    if(p == freep)
 711:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 787:	0a 00 00 
 78a:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 dc 0a 00 00       	mov    $0xadc,%eax
 799:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 7a0:	00 00 00 
