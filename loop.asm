...
main(int argc, char *argv[])
{
  ...
  19:	ff 76 04             	pushl  0x4(%esi)
  1c:	e8 1f 03 00 00       	call   340 <atoi>
	int nice = 20; 
	int sum = 0;
	int t0, t1;
  ...
  24:	83 ff 01             	cmp    $0x1,%edi
  27:	0f 8e 00 01 00 00    	jle    12d <main+0x12d>
  2d:	89 c3                	mov    %eax,%ebx
		printf(1, "Usage: loop count [nice, default=20] \n");
		exit();
	}
	if (argv[2]) nice = atoi(argv[2]);
  2f:	8b 46 08             	mov    0x8(%esi),%eax
	int nice = 20; 
  32:	be 14 00 00 00       	mov    $0x14,%esi
	if (argv[2]) nice = atoi(argv[2]);
  37:	85 c0                	test   %eax,%eax
  39:	74 0e                	je     49 <main+0x49>
  3b:	83 ec 0c             	sub    $0xc,%esp
  3e:	50                   	push   %eax
  3f:	e8 fc 02 00 00       	call   340 <atoi>
  ...
  4c:	53                   	push   %ebx
  4d:	68 c0 08 00 00       	push   $0x8c0
  52:	6a 01                	push   $0x1
  54:	e8 c7 04 00 00       	call   520 <printf>

	t0 = uptime();
  59:	e8 ec 03 00 00       	call   44a <uptime>
  5e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	setnice(getpid(), nice);
  61:	e8 cc 03 00 00       	call   432 <getpid>
  66:	59                   	pop    %ecx
  67:	5f                   	pop    %edi
  68:	56                   	push   %esi
  69:	50                   	push   %eax
  ...
  6c:	31 ff                	xor    %edi,%edi
	setnice(getpid(), nice);
  6e:	e8 ef 03 00 00       	call   462 <setnice>
	for (i=sum=0; i<count; i++) {
  73:	83 c4 10             	add    $0x10,%esp
  76:	85 db                	test   %ebx,%ebx
  78:	7e 76                	jle    f0 <main+0xf0>
  7a:	31 c9                	xor    %ecx,%ecx
	if (x==0) return 1;
  7c:	85 c9                	test   %ecx,%ecx
  7e:	89 c8                	mov    %ecx,%eax
  80:	74 29                	je     ab <main+0xab>
  82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  88:	ba 01 00 00 00       	mov    $0x1,%edx
  8d:	8d 76 00             	lea    0x0(%esi),%esi
  90:	0f af d0             	imul   %eax,%edx
  93:	83 e8 01             	sub    $0x1,%eax
  96:	75 f8                	jne    90 <main+0x90>
		if(i == 10 && (getnice(getpid()) == 20)){
			setnice(getpid(), 40);
		}
		for (j=0; j<5000; j++){
			sum += fact(j);
  98:	01 d6                	add    %edx,%esi
		for (j=0; j<5000; j++){
  9a:	81 f9 87 13 00 00    	cmp    $0x1387,%ecx
  a0:	74 0e                	je     b0 <main+0xb0>
  a2:	83 c1 01             	add    $0x1,%ecx
	if (x==0) return 1;
  a5:	85 c9                	test   %ecx,%ecx
  a7:	89 c8                	mov    %ecx,%eax
  a9:	75 dd                	jne    88 <main+0x88>
			sum += fact(j);
  ab:	83 c6 01             	add    $0x1,%esi
  ae:	eb f2                	jmp    a2 <main+0xa2>
	for (i=sum=0; i<count; i++) {
  b0:	83 c7 01             	add    $0x1,%edi
  b3:	39 fb                	cmp    %edi,%ebx
  b5:	74 39                	je     f0 <main+0xf0>
		if(i == 10 && (getnice(getpid()) == 20)){
  b7:	83 ff 0a             	cmp    $0xa,%edi
  ba:	75 be                	jne    7a <main+0x7a>
  bc:	e8 71 03 00 00       	call   432 <getpid>
  c1:	83 ec 0c             	sub    $0xc,%esp
  c4:	50                   	push   %eax
  c5:	e8 90 03 00 00       	call   45a <getnice>
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	83 f8 14             	cmp    $0x14,%eax
  d0:	75 a8                	jne    7a <main+0x7a>
			setnice(getpid(), 40);
  d2:	e8 5b 03 00 00       	call   432 <getpid>
  d7:	52                   	push   %edx
  d8:	52                   	push   %edx
  d9:	6a 28                	push   $0x28
  db:	50                   	push   %eax
  dc:	e8 81 03 00 00       	call   462 <setnice>
  e1:	83 c4 10             	add    $0x10,%esp
  e4:	eb 94                	jmp    7a <main+0x7a>
  ...
  f3:	56                   	push   %esi
  f4:	68 d1 08 00 00       	push   $0x8d1
  f9:	6a 01                	push   $0x1
  fb:	e8 20 04 00 00       	call   520 <printf>

	t1 = uptime();
 100:	e8 45 03 00 00       	call   44a <uptime>

	printf(1, "\nNice: %d => Elapsed time: %d\n", getnice(getpid()), t1-t0);
 105:	2b 45 e4             	sub    -0x1c(%ebp),%eax
 108:	89 c3                	mov    %eax,%ebx
 10a:	e8 23 03 00 00       	call   432 <getpid>
 10f:	89 04 24             	mov    %eax,(%esp)
 112:	e8 43 03 00 00       	call   45a <getnice>
 117:	53                   	push   %ebx
 118:	50                   	push   %eax
 119:	68 a0 08 00 00       	push   $0x8a0
 11e:	6a 01                	push   $0x1
 120:	e8 fb 03 00 00       	call   520 <printf>

	exit();
 125:	83 c4 20             	add    $0x20,%esp
 128:	e8 85 02 00 00       	call   3b2 <exit>
		printf(1, "Usage: loop count [nice, default=20] \n");
 12d:	50                   	push   %eax
 12e:	50                   	push   %eax
 12f:	68 78 08 00 00       	push   $0x878
 134:	6a 01                	push   $0x1
 136:	e8 e5 03 00 00       	call   520 <printf>
		exit();
 13b:	e8 72 02 00 00       	call   3b2 <exit>
 ...
 141:	b8 01 00 00 00       	mov    $0x1,%eax
{
 ...
 14d:	74 09                	je     158 <fact+0x18>
 14f:	90                   	nop
 150:	0f af c2             	imul   %edx,%eax
 153:	83 ea 01             	sub    $0x1,%edx
 156:	75 f8                	jne    150 <fact+0x10>
}
 158:	5d                   	pop    %ebp
 159:	c3                   	ret    
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4b7:	f7 f1                	div    %ecx
 4b9:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6d4:	e9 8f fe ff ff       	jmp    568 <printf+0x48>
          s = "(null)";
 6d9:	bb db 08 00 00       	mov    $0x8db,%ebx
        while(*s != 0){
 ...
 6f1:	a1 b4 0b 00 00       	mov    0xbb4,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 72f:	a3 b4 0b 00 00       	mov    %eax,0xbb4
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 7cf:	73 47                	jae    818 <malloc+0x98>
    ...
    if(p == freep)
 7d1:	39 05 b4 0b 00 00    	cmp    %eax,0xbb4
 ...
 7f6:	e8 f5 fe ff ff       	call   6f0 <free>
  return freep;
 7fb:	8b 15 b4 0b 00 00    	mov    0xbb4,%edx
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 827:	89 15 b4 0b 00 00    	mov    %edx,0xbb4
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 b4 0b 00 00 b8 	movl   $0xbb8,0xbb4
 847:	0b 00 00 
 84a:	c7 05 b8 0b 00 00 b8 	movl   $0xbb8,0xbb8
 851:	0b 00 00 
    base.s.size = 0;
 854:	b8 b8 0b 00 00       	mov    $0xbb8,%eax
 859:	c7 05 bc 0b 00 00 00 	movl   $0x0,0xbbc
 860:	00 00 00 
