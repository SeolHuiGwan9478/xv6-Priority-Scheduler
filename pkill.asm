...
int main(int argv, char* argc[]){
  ...
  15:	ff 73 04             	pushl  0x4(%ebx)
  18:	e8 33 02 00 00       	call   250 <atoi>
  1d:	89 04 24             	mov    %eax,(%esp)
  20:	e8 cd 02 00 00       	call   2f2 <kill>

	if(!rst){
  25:	83 c4 10             	add    $0x10,%esp
  28:	85 c0                	test   %eax,%eax
  2a:	75 20                	jne    4c <main+0x4c>
		printf(1,"PID# %d is killed\n",atoi(argc[1]));
  2c:	83 ec 0c             	sub    $0xc,%esp
  2f:	ff 73 04             	pushl  0x4(%ebx)
  32:	e8 19 02 00 00       	call   250 <atoi>
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 88 07 00 00       	push   $0x788
  40:	6a 01                	push   $0x1
  42:	e8 e9 03 00 00       	call   430 <printf>
		exit();
  47:	e8 76 02 00 00       	call   2c2 <exit>
	}
	else{
		printf(1,"PID# %d is wrong\n",atoi(argc[1]));
  4c:	83 ec 0c             	sub    $0xc,%esp
  4f:	ff 73 04             	pushl  0x4(%ebx)
  52:	e8 f9 01 00 00       	call   250 <atoi>
  57:	83 c4 0c             	add    $0xc,%esp
  5a:	50                   	push   %eax
  5b:	68 9b 07 00 00       	push   $0x79b
  60:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb ad 07 00 00       	mov    $0x7ad,%ebx
        while(*s != 0){
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 ...
 757:	0a 00 00 
 75a:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 60 0a 00 00       	mov    $0xa60,%eax
 769:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 770:	00 00 00 
